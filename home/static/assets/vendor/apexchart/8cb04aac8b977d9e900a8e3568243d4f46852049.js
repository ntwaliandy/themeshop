!function(t, e) {
        ...
        return s(i, [{
            ...
            value: function(t) {
                var e = getComputedStyle(t)
                  ...
                  , s = t.clientHeight
                  , a = t.clientWidth;
                return s -= parseFloat(e.paddingTop) + parseFloat(e.paddingBottom),
      ...
      , u = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                "none" !== e.config.states.normal.filter ? this.applyFilter(t, e.config.states.normal.filter.type, e.config.states.normal.filter.value) : e.config.chart.dropShadow.enabled && this.dropShadow(t, e.config.chart.dropShadow)
            }
        }, {
            key: "addNormalFilter",
            value: function(t) {
            ...
            value: function(t, e) {
                ...
                t.filter(function(t) {
                    var e = null;
                    e = d.isSafari() || d.isFirefox() || d.isIE() ? t.flood(n, r).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a) : t.flood(n, r).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a).merge(t.source),
                    t.blend(t.source, e)
                }),
      ...
      , g = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i, s, a, n, r) {
                ...
                i || (i = t.attr("pathFrom")),
                s || (s = t.attr("pathTo")),
                (!i || i.indexOf("undefined") > -1 || i.indexOf("NaN") > -1) && (i = "M 0 ".concat(l.globals.gridHeight),
                a = 1),
                (s.indexOf("undefined") > -1 || s.indexOf("NaN") > -1) && (s = "M 0 ".concat(l.globals.gridHeight),
                a = 1),
                l.globals.shouldAnimate || (a = 1),
                t.plot(i).animate(1, l.globals.easing, r).plot(i).animate(a, l.globals.easing, r).plot(s).afterAll(function() {
                    d.isNumber(e) ? e === l.globals.series[l.globals.maxValsInArrayIndex].length - 2 && l.globals.shouldAnimate && (l.globals.animationEnded = !0) : l.globals.shouldAnimate && (l.globals.animationEnded = !0,
                    "function" == typeof l.config.chart.events.animationEnd && l.config.chart.events.animationEnd(o.ctx, l)),
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null
                  , s = null;
                return null === i ? s = ["L", t, e].join(" ") : "H" === i ? s = ["H", t].join(" ") : "V" === i && (s = ["V", e].join(" ")),
                s
            }
        }, {
            key: "curve",
            ...
            value: function(t) {
                ...
                if (T.attr("id", "".concat(m, "-").concat(i)),
                T.attr("index", a),
                y && T.attr({
                ...
                k && (T.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, T)),
            ...
            value: function(t, e, i, s, a) {
                ...
                if (g) {
                    ...
                    "vertical" === t ? f.from(0, 0).to(0, 1) : "diagonal" === t ? f.from(0, 0).to(1, 1) : "horizontal" === t ? f.from(0, 1).to(1, 1) : "diagonal2" === t && f.from(0, 1).to(2, 2);
                return f
            }
        }, {
            key: "drawText",
            value: function(t) {
                var e, i = this.w, s = t.x, a = t.y, n = t.text, r = t.textAnchor, o = t.fontSize, l = t.fontFamily, h = t.foreColor, c = t.opacity;
                return r || (r = "start"),
            ...
            value: function(t, e, i) {
                ...
                if ("square" === i.shape) {
                    ...
                    "circle" === i.shape && (d.isNumber(e) || (s = 0,
                    e = 0),
                    a = this.drawCircle(s, {
                        cx: t,
                        cy: e,
            ...
            value: function(t, e) {
                ...
                if ("true" === t.node.getAttribute("selected")) {
                    ...
                    i.globals.selectedDataPoints[a].indexOf(n) > -1) {
                ...
                if ("true" === r) {
                    ...
                    "none" !== i.config.states.active.filter.type && s.getDefaultFilter(t);
            ...
            value: function(t, e, i, s) {
                ...
                s && r.attr("transform", s),
                n.globals.dom.Paper.add(r);
                var o = r.bbox();
                return a || (o = r.node.getBoundingClientRect()),
                r.remove(),
                {
                    width: o.width,
                    height: o.height
            ...
            value: function(t, e, i) {
                if (t.textContent = e,
                e.length > 0 && t.getSubStringLength(0, e.length) >= i) {
    ...
    var p = {
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                if (t.globals.axisCharts) {
                    ...
                    this.setOrientations(t.config.annotations.xaxis),
            ...
            value: function(t, e, i) {
                var s, a = this.w, n = t.strokeDashArray;
                if (this.invertAxis) {
                    ...
                    s = a.globals.gridHeight - (t.y - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight);
                ...
                t.map(function(t, a) {
                    if ("vertical" === t.label.orientation) {
                        ...
                        if (null !== r) {
                            ...
                            r.setAttribute("x", parseFloat(r.getAttribute("x")) - o.height + 4),
                            "top" === t.label.position ? r.setAttribute("y", parseFloat(r.getAttribute("y")) + o.width) : r.setAttribute("y", parseFloat(r.getAttribute("y")) - o.width);
            ...
            value: function(t, e) {
                ...
                "vertical" === e.label.orientation && (r = e.label.style.padding.left,
            ...
            value: function(t, e, i) {
                ...
                return P.before(T),
                e && z.globals.memory.methodsToExec.push({
                    context: L,
                    method: L.addText,
                    params: {
                        x: s,
            ...
            value: function(t) {
                ...
                return l.insertBefore(p.node, f),
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                n.isMultipleYAxis)
                    ...
                    n.yRange.push(Math.abs(n.minY - n.maxY));
        ...
        return s(i, [{
            ...
            value: function() {
                ...
                if (e && "object" === t(e)) {
                    ...
                    "line" !== e.chart.type && "area" !== e.chart.type && "scatter" !== e.chart.type || o.comboChartsHasBars || "datetime" === e.xaxis.type || "between" === e.xaxis.tickPlacement || s.convertCatToNumeric(),
                ...
                return a = d.extend(l, e),
                a = this.handleUserInputErrors(a)
            }
        }, {
            key: "extendYAxis",
            value: function(t) {
            ...
            value: function(t) {
                var e = new x;
                return t.annotations.yaxis = d.extendArray(void 0 !== t.annotations.yaxis ? t.annotations.yaxis : [], e.yAxisAnnotation),
                t
            }
        }, {
            ...
            value: function(t) {
                var e = new x;
                return t.annotations.xaxis = d.extendArray(void 0 !== t.annotations.xaxis ? t.annotations.xaxis : [], e.xAxisAnnotation),
                t
            }
        }, {
            ...
            value: function(t) {
                var e = new x;
                return t.annotations.points = d.extendArray(void 0 !== t.annotations.points ? t.annotations.points : [], e.pointAnnotation),
                t
            }
        }, {
            ...
            value: function(t) {
                ...
                return "bar" === e.chart.type && e.tooltip.shared && ("barWidth" === e.xaxis.crosshairs.width && e.series.length > 1 && (console.warn('crosshairs.width = "barWidth" is only supported in single series, not in a multi-series barChart'),
      ...
      , w = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                return e.initialConfig = d.extend({}, t),
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                var o = this.getFillColors()
                  ...
                  , c = l;
                return e.color && (l = e.color),
                -1 === l.indexOf("rgb") ? c = d.hexToRgba(l, h) : l.indexOf("rgba") > -1 && (h = "0." + d.getOpacityFromRGBA(o[this.seriesIndex])),
                ...
                r.fill.image.src.length > 0 && "image" === r.fill.type ? e.seriesNumber < r.fill.image.src.length ? (this.clippedImgArea({
                    opacity: h,
                    image: r.fill.image.src[e.seriesNumber],
                    patternID: "pattern".concat(i.globals.cuid).concat(e.seriesNumber + 1)
                }),
                s = "url(#pattern".concat(i.globals.cuid).concat(e.seriesNumber + 1, ")")) : s = c : s = "gradient" === r.fill.type ? n : "pattern" === r.fill.type ? a : c,
                e.solid && (s = c),
                s
            }
        }, {
            ...
            value: function() {
                var t = this.w
                  ...
                  , i = this.opts
                  , s = [];
                return t.globals.comboCharts ? "line" === t.config.series[this.seriesIndex].type ? t.globals.stroke.colors instanceof Array ? s = t.globals.stroke.colors : s.push(t.globals.stroke.colors) : t.globals.fill.colors instanceof Array ? s = t.globals.fill.colors : s.push(t.globals.fill.colors) : "line" === e.chart.type ? t.globals.stroke.colors instanceof Array ? s = t.globals.stroke.colors : s.push(t.globals.stroke.colors) : t.globals.fill.colors instanceof Array ? s = t.globals.fill.colors : s.push(t.globals.fill.colors),
                void 0 !== i.fillColors && (s = [],
                i.fillColors instanceof Array ? s = i.fillColors.slice() : s.push(i.fillColors)),
                s
            }
        }, {
            ...
            value: function(t, e, i, s) {
                var a, n, r = this.w.config, o = this.opts, l = new f(this.ctx), h = new d, c = r.fill.gradient.type, u = void 0 === r.fill.gradient.opacityFrom ? i : Array.isArray(r.fill.gradient.opacityFrom) ? r.fill.gradient.opacityFrom[s] : r.fill.gradient.opacityFrom, g = void 0 === r.fill.gradient.opacityTo ? i : Array.isArray(r.fill.gradient.opacityTo) ? r.fill.gradient.opacityTo[s] : r.fill.gradient.opacityTo;
                if (a = e,
      ...
      , S = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                var s, a = this, n = this.w, r = t, o = null, l = new f(this.ctx);
                ...
                r.x instanceof Array)
                    for (var h = function(t) {
                        ...
                        if ("line" !== n.config.chart.type && "area" !== n.config.chart.type || n.globals.comboCharts || n.config.tooltip.intersect || (c += " no-pointer-events"),
                        Array.isArray(n.config.markers.size) ? n.globals.markers.size[e] > 0 : n.config.markers.size > 0) {
                            ...
                            n.config.markers.discrete.map(function(t) {
                                t.seriesIndex === e && t.dataPointIndex === h && (g.pointStrokeColor = t.strokeColor,
                                g.pointFillColor = t.fillColor,
                                g.pSize = t.size)
                            }),
                            (s = l.drawMarker(r.x[t], r.y[t], g)).attr("rel", h),
                            s.attr("j", h),
                            s.attr("index", e),
                            s.node.setAttribute("default-marker-size", g.pSize),
                            new u(a.ctx).setSelectionFilter(s, e, h),
                            a.addEvents(s),
                            o && o.add(s)
                        } else
            ...
            value: function(t) {
                ...
                t.node.addEventListener("touchstart", e.pathMouseDown.bind(this.ctx, t), {
                    passive: !0
                })
            }
        }, {
      ...
      , C = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                if (x.attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")),
                h.x instanceof Array)
                    for (var b = 0; b < h.x.length; b++) {
                        ...
                        c !== 1 / 0 && (y = s.globals.seriesZ[l][m] / c,
                        ...
                        if (k = k || 0,
                        v = v || 0,
                        0 === (w = w || 0) && 0 === k || void 0 === s.globals.series[l][m])
                            return;
                        ...
                        if (s.globals.dataChanged)
                            if (this.dynamicAnim) {
                                var z, M = s.config.chart.animations.dynamicAnimation.speed, P = void 0, E = void 0, T = void 0;
                                null != (z = s.globals.previousPaths[l] && s.globals.previousPaths[l][e]) && (P = z.x,
                                E = z.y,
                                T = void 0 !== z.r ? z.r : y);
                                for (var X = 0; X < s.globals.collapsedSeries.length; X++)
                                    s.globals.collapsedSeries[X].index === l && (M = 1,
                                    y = 0);
                                0 === w && 0 === k && (y = 0),
                                a.animateCircle(C, {
                                    cx: P,
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                var s = this.w
                  ...
                  , l = i
                  , h = null;
                if (!n.enabled || t.x instanceof Array != !0)
                    return h;
                (h = a.group({
                    class: "apexcharts-data-labels"
                })).attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")"));
                for (var c = 0; c < t.x.length; c++)
                    if (r = t.x[c] + n.offsetX,
                    o = t.y[c] + n.offsetY - s.globals.markers.size[e] - 5,
                    !isNaN(r)) {
                        1 === i && 0 === c && (l = 0),
                        1 === i && 1 === c && (l = 1);
                        ...
                        if ("bubble" === s.config.chart.type)
                            ...
                            void 0 !== d && (u = s.config.dataLabels.formatter(d, {
                                seriesIndex: e,
                                dataPointIndex: l,
                                w: s
                            }));
            ...
            value: function(t) {
                ...
                if (t.offsetCorrection && (g = this.dataLabelsCorrection(s, a, o, n, r, d, parseInt(c.style.fontSize))),
                e.globals.zoomed || (s = g.x,
                a = g.y),
                g.drawnextLabel) {
                    var p = i.drawText({
                        width: 100,
      ...
      , z = function() {
        function t(i, s) {
            ...
            this.isNullValue = !1,
            this.xyRatios = s,
            null !== this.xyRatios && (this.xRatio = s.xRatio,
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                for (var l = function(r, l) {
                    var h, c, d, u, g = void 0, f = void 0, p = void 0, x = void 0, b = [], m = [], v = s.globals.comboCharts ? e[r] : r, y = a.group({
                    ...
                    h = S.xDivision,
                    d = S.zeroH,
                    i.horizontal || m.push(p + k / 2);
                    for (var C = a.group({
                        class: "apexcharts-datalabels"
                    }), L = function(e, a) {
                        void 0 === i.series[r][e] || null === t[r][e] ? i.isNullValue = !0 : i.isNullValue = !1,
                        s.config.stroke.show && (A = i.isNullValue ? 0 : Array.isArray(i.strokeWidth) ? i.strokeWidth[v] : i.strokeWidth);
                        var o = null;
                    ...
                    }, z = 0, M = s.globals.dataPoints; z < s.globals.dataPoints; z++,
                    M--)
                        L(z);
                    s.globals.seriesXvalues[v] = m,
                    s.globals.seriesYvalues[v] = b,
                    o.add(y)
                }, h = 0, c = 0; h < t.length; h++,
                c++)
                    l(h, c);
                return o
            }
            ...
            value: function(t) {
                ...
                new u(this.ctx).setSelectionFilter(A, e, a),
                h.add(A);
            ...
            value: function(t) {
                ...
                this.visibleItems = 1;
                for (var s = 0; s < t.length; s++)
                    if (t[s].length > 0 && (this.seriesLen = this.seriesLen + 1,
                    this.totalItems += t[s].length),
                    i.globals.isXNumeric) {
                        ...
                        for (var a = 0; a < t[s].length; a++)
                            i.globals.seriesX[s][a] > i.globals.minX && i.globals.seriesX[s][a] < i.globals.maxX && this.visibleItems++
                    } else
                        this.visibleItems = i.globals.dataPoints;
            ...
            value: function() {
                ...
                if (this.isHorizontal)
                    ...
                    if (n = (s = l.globals.gridWidth / this.visibleItems) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100,
            ...
            value: function(t) {
                ...
                a = u.move(r, m),
                n = u.move(r, m),
                d.globals.previousPaths.length > 0 && (n = this.getPathFrom(x, p));
                var v = {
                    barHeight: i,
                    strokeWidth: s,
                    barYPosition: m,
                ...
                if (a = a + u.line(y.newX, m) + y.path + u.line(r, m + i - s) + u.line(r, m),
            ...
            value: function(t) {
                ...
                n = u.move(m, l),
                r = u.move(m, l),
                d.globals.previousPaths.length > 0 && (r = this.getPathFrom(x, p));
                var v = {
                    barWidth: o,
                    strokeWidth: h,
                    barXPosition: m,
                  ...
                  , y = this.barEndingShape(d, v, this.series, g, p);
                if (n = n + u.line(m, y.newY) + y.path + u.line(m + o - h, l) + u.line(m, l),
                r = r + u.line(m, l) + y.ending_p_from + u.line(m + o - h, l) + u.line(m + o - h, l) + u.line(m, l),
            ...
            value: function(t) {
                var e = t.x
                  ...
                  , p = e + parseFloat(l * h)
                  , x = i + parseFloat(o * h);
                d.globals.isXNumeric && (p = e + parseFloat(l * (h + 1)) - g,
            ...
            value: function(t) {
                var e, i = this.w, s = t.i, a = t.j, n = t.realIndex, r = t.y, o = t.bcx, l = t.barWidth, h = t.textRects, c = t.dataLabelsY, d = t.barDataLabelsConfig, u = t.strokeWidth, g = t.offX, f = t.offY, p = this.series[s][a] / this.yRatio[this.yaxisIndex], x = i.globals.gridWidth / i.globals.dataPoints;
                o -= u / 2,
                e = i.globals.isXNumeric ? o - l / 2 + g : o - x + l / 2 + g;
                ...
                case "center":
                    ...
                    m && (c = b ? r + p / 2 + h.height / 2 + f : r + p / 2 + h.height / 2 - f);
                    break;
                case "bottom":
            ...
            value: function(t, e, i, s, a) {
                ...
                if (this.isHorizontal) {
                    ...
                    if (void 0 !== i[s][a] || null !== i[s][a]) {
                        ...
                        switch (h && (c = -e.barHeight / 2 - e.strokeWidth),
                        t.config.chart.stacked || ("arrow" === this.barOptions.endingShape ? l = e.x - c : "rounded" === this.barOptions.endingShape && (l = e.x - c / 2)),
                        this.barOptions.endingShape) {
                        case "flat":
                            r = n.line(l, e.barYPosition + e.barHeight - e.strokeWidth);
                            break;
                        case "arrow":
                            r = n.line(l + c, e.barYPosition + (e.barHeight - e.strokeWidth) / 2) + n.line(l, e.barYPosition + e.barHeight - e.strokeWidth),
                ...
                if (void 0 !== i[s][a] || null !== i[s][a]) {
                    ...
                    switch (p && (x = -e.barWidth / 2 - e.strokeWidth),
                    t.config.chart.stacked || ("arrow" === this.barOptions.endingShape ? g += x : "rounded" === this.barOptions.endingShape && (g += x / 2)),
                    this.barOptions.endingShape) {
                    case "flat":
                        d = n.line(e.barXPosition + e.barWidth - e.strokeWidth, g);
                        break;
                    case "arrow":
                        d = n.line(e.barXPosition + (e.barWidth - e.strokeWidth) / 2, g - x) + n.line(e.barXPosition + e.barWidth - e.strokeWidth, g),
      ...
      , M = function(t) {
        function i() {
            return e(this, i),
            h(this, o(i).apply(this, arguments))
        }
        return r(i, z),
        s(i, [{
            key: "draw",
            value: function(t, e) {
                ...
                this.series = t,
                this.initVariables(t),
                "100%" === s.config.chart.stackType && (this.series = s.globals.seriesPercent.slice(),
                t = this.series),
                this.totalItems = 0,
                this.prevY = [],
                this.prevX = [],
                ...
                for (var o = 0, l = 0, h = function(a, n) {
                    ...
                    var m, v, y = i.graphics.group({
                        ...
                        class: "apexcharts-datalabels"
                    }), k = 0, A = i.initialPositions(o, l, d, u, g, f);
                    l = A.y,
                    m = A.barHeight,
                    u = A.yDivision,
                    f = A.zeroW,
            ...
            value: function(t, e, i, s, a, n) {
                var r, o, l = this.w;
                return this.isHorizontal ? (r = (r = s = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight) / 100,
                n = this.baseLineInvertedY + l.globals.padHorizontal,
                e = (s - r) / 2) : (o = i = l.globals.gridWidth / l.globals.dataPoints,
                o = l.globals.isXNumeric ? (i = this.minXDiff / this.xRatio) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100 : o * parseInt(l.config.plotOptions.bar.columnWidth) / 100,
            ...
            value: function(t) {
                ...
                if (f > 0) {
                    var y = o;
                    this.prevXVal[f - 1][p] < 0 ? y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] + m : this.prevX[f - 1][p] : this.prevXVal[f - 1][p] >= 0 && (y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] : this.prevX[f - 1][p] - m),
                    e = y
                } else
                    e = o;
                ...
                if (this.series.length > 1 && f !== this.endingShapeOnSeriesNumber && (k.path = this.graphics.line(k.newX, g + s - a)),
            ...
            value: function(t) {
                ...
                s = (this.series[u][g],
                b - this.series[u][g] / this.yRatio[this.yaxisIndex]);
                var k = {
                    barWidth: o,
                    strokeWidth: h,
                ...
                if (this.series.length > 1 && u !== this.endingShapeOnSeriesNumber && (A.path = this.graphics.line(m + o - h, A.newY)),
                ...
                n = n + this.graphics.line(m, A.newY) + A.path + this.graphics.line(m + o - h, b) + this.graphics.line(m, b),
                r = r + this.graphics.line(m, b) + this.graphics.line(m + o - h, b) + this.graphics.line(m + o - h, b) + this.graphics.line(m + o - h, b) + this.graphics.line(m, b),
      ...
      , P = function(t) {
        ...
        s(i, [{
            ...
            value: function(t, e) {
                ...
                l++) {
                    var h, c, d = void 0, u = void 0, g = void 0, p = void 0, x = [], b = [], m = i.globals.comboCharts ? e[o] : o, y = s.group({
                    ...
                    for (var L = s.group({
                        class: "apexcharts-datalabels"
                    }), z = 0, M = i.globals.dataPoints; z < i.globals.dataPoints; z++,
                    M--) {
                        void 0 === this.series[o][z] || null === t[o][z] ? this.isNullValue = !0 : this.isNullValue = !1,
                        i.config.stroke.show && (S = this.isNullValue ? 0 : Array.isArray(this.strokeWidth) ? this.strokeWidth[m] : this.strokeWidth);
            ...
            value: function(t) {
                ...
                void 0 === this.series[d][u] || null === this.series[d][u] ? k = o : (k = o - k / b,
                A = o - A / b,
                y = o - v.h / b,
                w = o - v.l / b),
                a = c.move(S, A) + c.line(S + r / 2, A) + c.line(S + r / 2, y) + c.line(S + r / 2, A) + c.line(S + r, A) + c.line(S + r, k) + c.line(S + r / 2, k) + c.line(S + r / 2, w) + c.line(S + r / 2, k) + c.line(S, k) + c.line(S, A - l / 2),
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                var i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2]
                  ...
                  , r = [""].concat(c(a.shortMonths))
                  , o = [""].concat(c(a.days))
                  , l = [""].concat(c(a.shortDays));
                function h(t, e) {
                    var i = t + "";
      ...
      , X = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                for (var a = e.globals.gridWidth / e.globals.dataPoints, n = e.globals.gridHeight / e.globals.series.length, r = 0, o = t.length - 1; o >= 0; o--) {
                    ...
                    for (var c = 0, g = 0; g < t[o].length; g++) {
                        ...
                        e.config.chart.animations.enabled && !e.globals.dataChanged) {
                            var k = 1;
                            e.globals.resized || (k = e.config.chart.animations.speed),
                            this.animateHeatMap(w, c, r, a, n, k)
                        }
                        if (e.globals.dataChanged) {
                            ...
                            if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                                ...
                                S || (S = "rgba(255, 255, 255, 1)"),
                                this.animateHeatColor(w, d.rgb2hex(S), d.rgb2hex(m), A)
                            }
                        }
                ...
                return e.config.yaxis[0].labels.offsetY = -L / 2,
                s
            }
        }, {
            ...
            value: function(t, e) {
                ...
                a.distributed || (o = i.globals.minY,
                l = i.globals.maxY),
                void 0 !== a.colorScale.min && (o = a.colorScale.min < i.globals.minY ? a.colorScale.min : i.globals.minY,
                ...
                a.colorScale.ranges.length > 0 && a.colorScale.ranges.map(function(t, e) {
                    s >= t.from && s <= t.to && (r = t.color,
                    o = t.from,
                    l = t.to,
                    h = Math.abs(l) + Math.abs(o),
                    d = 100 * s / h)
                });
                return {
                    color: r,
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                if (e.globals.dataChanged) {
                    ...
                    for (var p = 0; p < e.globals.previousPaths.length; p++)
                        c = this.fullAngle * d.negToZero(e.globals.previousPaths[p]) / u,
            ...
            value: function(t, e) {
                ...
                for (var g = 0; g < t.length; g++) {
                    ...
                    var w = void 0;
                    "pie" === i.config.chart.type ? w = d.polarToCartesian(this.centerX, this.centerY, this.size / 1.25 + i.config.plotOptions.pie.dataLabels.offset, o + (h - o) / 2) : "donut" === i.config.chart.type && (w = d.polarToCartesian(this.centerX, this.centerY, (this.size + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, o + (h - o) / 2)),
                    p.add(v);
                    var k = 0;
                    ...
                    i.config.dataLabels.enabled) {
                        ...
                        if (0 !== x) {
                            ...
                            i.config.chart.animations.animate && !1 === i.globals.resized && (P.node.classList.add("apexcharts-pie-label-delay"),
            ...
            value: function(t, e) {
                ...
                a = e.prevEndAngle - e.prevStartAngle),
            ...
            value: function(t, e, i, s, a, n) {
                ...
                0 !== c.dur ? t.animate(c.dur, l.globals.easing, c.animBeginArr[c.i]).afterAll(function() {
                    ...
                    d = g + (s - g) * l,
                    n.animateStartingPos && (d = a + (s - a) * l,
                    u = e - a + (i - (e - a)) * l),
                    r = o.getPiePath({
                        me: o,
                        startAngle: u,
            ...
            key: "pieClicked",
            value: function(t) {
                var e, i = this.w, s = this.size + 5, a = i.globals.dom.Paper.select("#apexcharts-pieSlice-" + t).members[0], n = a.attr("d");
            ...
            value: function(t) {
                ...
                for (var v = m ? t.series.length - 1 : 0; m ? v >= 0 : v < t.series.length; m ? v-- : v++) {
                    ...
                    var w = s.fillPath(y, {
                      ...
                      , M = void 0;
                    e.globals.dataChanged && (S = this.startAngle,
                    M = Math.round(C * d.negToZero(e.globals.previousPaths[v]) / 100) + S),
                    Math.abs(z) + Math.abs(k) >= 360 && (z -= .01),
                    Math.abs(M) + Math.abs(S) >= 360 && (M -= .01);
                    var P = z - k
                    ...
                    var F = 0;
                    !I.initialAnim || e.globals.resized || e.globals.dataChanged || (F = (z - k) / 360 * e.config.chart.animations.speed,
                    this.animDur = F / (1.2 * t.series.length) + this.animDur,
                    this.animBeginArr.push(this.animDur)),
                    e.globals.dataChanged && (F = (z - k) / 360 * e.config.chart.animations.dynamicAnimation.speed,
                    this.animDur = F / (1.2 * t.series.length) + this.animDur,
                    this.animBeginArr.push(this.animDur)),
                    I.animatePaths(T, {
                        centerX: t.centerX,
                ...
                if (a.config.plotOptions.radialBar.hollow.imageClipped)
                    ...
                    if (void 0 === l && void 0 === h) {
                        ...
                        var d = a.globals.dom.Paper.image(o).loaded(function(e) {
                            this.move(t.centerX - l / 2 + a.config.plotOptions.radialBar.hollow.imageOffsetX, t.centerY - h / 2 + a.config.plotOptions.radialBar.hollow.imageOffsetY),
                            this.size(l, h)
                        });
                        e.add(d)
                    }
      ...
      , O = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], b = [], m = 0, y = 0; y < t.length; y++) {
                    ...
                    var C = []
                      ...
                      , P = M;
                    M > s.globals.gridHeight && (P = s.globals.gridHeight),
                    m = w / 2;
                    var E = s.globals.padHorizontal + m
                      , T = 1;
                    s.globals.isXNumeric && (E = (s.globals.seriesX[k][0] - s.globals.minX) / g),
                    z.push(E);
                    var X = void 0
                      , Y = void 0
                      , I = void 0
                    ...
                    null === t[y][0]) {
                        ...
                        X = a.move(_, G),
                        Y = a.move(_, P) + a.line(_, G);
                    if (I = a.move(-1, M) + a.line(-1, M),
                    ...
                    for (var Z = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, $ = 0; $ < Z; $++) {
                        ...
                        s.config.chart.stacked ? (j = y > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? b[y - 1][$ + 1] : M,
                        T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? j - J / c[this.yaxisIndex] : j - t[y][$ + 1] / c[this.yaxisIndex]) : T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? M - J / c[this.yaxisIndex] : M - t[y][$ + 1] / c[this.yaxisIndex],
                        z.push(E),
                        C.push(T);
                        ...
                        Y = Q.areaPath,
                        X = Q.linePath,
                        this.appendPathFrom && (I += a.line(E, M),
                        F += a.line(E, M));
            ...
            value: function(t) {
                ...
                if ("smooth" === b) {
                    var m = .35 * (a - r);
                    p.globals.hasNullValues ? (null !== e[i][s] && (null !== e[i][s + 1] ? (c = x.move(r, o) + x.curve(r + m, o, a - m, n, a + 1, n),
                    d = x.move(r + 1, o) + x.curve(r + m, o, a - m, n, a + 1, n) + x.line(a, h) + x.line(r, h) + "z") : (c = x.move(r, o),
                    d = x.move(r, o) + "z")),
                    u.push(c),
                    g.push(d)) : (c += x.curve(r + m, o, a - m, n, a, n),
                    d += x.curve(r + m, o, a - m, n, a, n)),
                    r = a,
                    o = n,
                    s === e[i].length - 2 && (d = d + x.curve(r, o, a, n, a, h) + x.move(a, n) + "z",
                    p.globals.hasNullValues || (u.push(c),
                    g.push(d)))
                } else
                    null === e[i][s + 1] && (c += x.move(a, n),
                    d = d + x.line(a - l, h) + x.move(a, n)),
                    null === e[i][s] && (c += x.move(a, n),
                    d += x.move(a, h)),
                    "stepline" === b ? (c = c + x.line(a, null, "H") + x.line(null, n, "V"),
                    d = d + x.line(a, null, "H") + x.line(null, n, "V")) : "straight" === b && (c += x.line(a, n),
                    d += x.line(a, n)),
                    s === e[i].length - 2 && (d = d + x.line(a, h) + x.move(a, n) + "z",
                    u.push(c),
                    g.push(d));
                return {
                    linePaths: u,
            ...
            value: function(t) {
                for (var e = t.pathFromLine, i = t.pathFromArea, s = t.realIndex, a = this.w, n = 0; n < a.globals.previousPaths.length; n++) {
                    ...
                    ("line" === r.type || "area" === r.type) && r.paths.length > 0 && parseInt(r.realIndex) === parseInt(s) && ("line" === r.type ? (this.appendPathFrom = !1,
                    e = a.globals.previousPaths[n].paths[0].d) : "area" === r.type && (this.appendPathFrom = !1,
                    a.config.stroke.show ? (e = a.globals.previousPaths[n].paths[0].d,
                    i = a.globals.previousPaths[n].paths[1].d) : i = a.globals.previousPaths[n].paths[0].d))
                }
                return {
                    pathFromLine: e,
                    pathFromArea: i
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                if (i.config.yaxis[e].labels.show)
                    for (var u = l; u >= 0; u--) {
                        ...
                        0 !== i.config.yaxis[e].labels.rotate && x.node.setAttribute("transform", "rotate(".concat(i.config.yaxis[e].labels.rotate, " ").concat(b.x, " ").concat(b.y, ")")),
                        c += h
                    }
                ...
                if (w.show) {
                    ...
                    r.add(A),
                    this.drawAxisTicks(k, l, w, i.config.yaxis[e].axisTicks, e, h, r)
                }
                return r
            }
        }, {
            ...
            value: function(t, e, i, s) {
                var a = this.w
                  ...
                  , r = 0
                  , o = 20;
                return s ? (r = e.width + a.config.yaxis[t].title.offsetX + o + i.width / 2 - 15,
                0 === (n += 1) && (r -= 15)) : (r = -1 * e.width + a.config.yaxis[t].title.offsetX + o + i.width / 2 - 15,
                this.isBarHorizontal && (o = 25,
                r = -1 * e.width - a.config.yaxis[t].title.offsetX - o)),
                {
                    xPos: r,
                    padd: o
                }
            ...
            value: function(t, e) {
                ...
                s.config.yaxis.map(function(l, h) {
                    var c = t[h].width + e[h].width
                      , d = i.multipleYs && e[h].width > 0 ? 2 * e[h].width : 15
                      , u = i.xPaddingForYAxisTitle(h, {
                        width: t[h].width
                    }, {
                        width: e[h].width
                    }, l.opposite);
                    if (s.config.yaxis.length > 1 ? c += Math.abs(u.padd) : void 0 === l.title.text ? c = c + Math.abs(u.padd) + 15 : c += Math.abs(u.padd),
                    l.opposite)
                        n = s.globals.gridWidth + s.globals.translateX + o + 30 + (s.globals.series.length - s.globals.collapsedSeries.length),
                        ...
                        a = i.multipleYs ? s.globals.translateX - c - r + d + parseInt(s.config.yaxis[h].labels.style.fontSize) + l.labels.offsetX : s.globals.translateX - c + t[h].width + l.labels.offsetX,
                        r += g,
      ...
      , R = function() {
        ...
        return s(t, [{
                ...
                if (e.config.xaxis.labels.show)
                    for (var d = 0; d <= c - 1; d++) {
                        var u = void 0 === r[d] ? "" : r[d]
                          , g = void 0;
                        g = new N(this.ctx).xLabelFormat(l, u),
                        void 0 !== h && (g = h(u, this.xaxisLabels[d], d));
                        var p = n - t / 2 + e.config.xaxis.labels.offsetX;
                        e.globals.timelineLabels.length > 0 ? (p = e.globals.timelineLabels[d].position,
                        g = e.globals.timelineLabels[d].value) : "datetime" === e.config.xaxis.type && void 0 === h && (g = ""),
                        (0 === (g = g.toString()).indexOf("NaN") || "undefined" === g || 0 === g.toLowerCase().indexOf("invalid") || g.toLowerCase().indexOf("infinity") >= 0 || this.drawnLabels.indexOf(g) >= 0 && !e.config.xaxis.labels.showDuplicates) && (g = ""),
                        ...
                        a.add(b),
                        i.addTspan(b, g, this.xaxisFontFamily);
            ...
            value: function(t) {
                var e, i, s = this.w, a = new f(this.ctx), n = a.group({
                ...
                if (s.config.xaxis.axisBorder.show) {
                    ...
                    n.add(b),
                    new D(this.ctx).drawAxisTicks(0, o.length, s.config.yaxis[0].axisBorder, s.config.yaxis[0].axisTicks, 0, e, n)
                }
                return n
            }
        }, {
            ...
            value: function() {
                ...
                if (t.globals.rotateXLabels || t.config.xaxis.labels.rotateAlways)
                    for (var r = 0; r < s.length; r++) {
                        ...
                        o.y = o.y - 1,
                        o.x = o.x + 1,
                        s[r].setAttribute("transform", "rotate(".concat(t.config.xaxis.labels.rotate, " ").concat(o.x, " ").concat(o.y, ")")),
      ...
      , H = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                e = t + .1) : t === e && (t = 0 === t ? 0 : t - .1,
                e = 0 === e ? 2 : e + .1);
                var a = []
                  , n = s + 1;
                n < 2 ? n = 2 : n > 2 && (n -= 2);
                for (var r = (e - t) / n, o = Math.floor(d.log10(r)), l = Math.pow(10, o), h = parseInt(r / l) * l, c = h * Math.floor(t / h), u = h * Math.ceil(e / h), g = c; a.push(g),
                !((g += h) > u); )
                    ;
                if (void 0 === this.w.config.yaxis[i].max && void 0 === this.w.config.yaxis[i].min || this.w.config.yaxis[i].forceNiceScale)
                    return {
                        result: a,
                        niceMin: a[0],
                ...
                var f = t;
                (a = []).push(f);
                for (var p = Math.abs(e - t) / s, x = 0; x <= s - 1; x++)
                    f += p,
                    a.push(f);
                return {
                    result: a,
            ...
            value: function(t, e, i, s) {
                ...
                for (var n = a.config.yaxis[t].logBase, r = Math.log(e) / Math.log(n), o = Math.log(i) / Math.log(n), l = Math.abs(i - e) / s, h = [], c = e; s >= 0; )
                    h.push(c),
                    c += l,
                    s -= 1;
            ...
            value: function(t, e, i) {
                ...
                n.logarithmic ? (s.allSeriesCollapsed = !1,
                s.yAxisScale[t] = this.logarithmicScale(t, e, i, n.tickAmount ? n.tickAmount : Math.floor(Math.log10(i)))) : i !== -Number.MAX_VALUE && d.isNumber(i) ? (s.allSeriesCollapsed = !1,
                s.yAxisScale[t] = this.niceScale(e, i, t, n.tickAmount ? n.tickAmount : 6)) : s.yAxisScale[t] = this.linearScale(0, 5, 5)
            }
        }, {
                ...
                t.forEach(function(t, e) {
                    c.forEach(function(t, i) {
                        ...
                        t.forEach(function(i, o) {
                            t[o].key === e && (void 0 !== a.yaxis[e].min && (n = a.yaxis[e].min),
            ...
            value: function(t, e) {
                ...
                return t.w.config.series.forEach(function(t) {
                    ...
                    t.data.forEach(function(t) {
                        t[0] <= e.xaxis.max && t[0] >= e.xaxis.min && (t[1] > a && null !== t[1] && (a = t[1]),
                        t[1] < s && null !== t[1] && (s = t[1]))
                    }),
                    s *= .95,
                    a *= 1.05,
                    i.push({
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                var o = a.series
                  , l = o
                  , h = o;
                "candlestick" === this.w.config.chart.type && (l = a.seriesCandleL,
                h = a.seriesCandleH);
                for (var u = t; u < s; u++) {
                    ...
                    for (var g = 0; g < a.series[u].length; g++)
                        null !== o[u][g] && d.isNumber(o[u][g]) ? (n = Math.max(n, h[u][g]),
                        e = Math.min(e, l[u][g]),
                        i = Math.max(i, l[u][g]),
                        d.isFloat(o[u][g]) && (a.yValueDecimal = Math.max(a.yValueDecimal, o[u][g].toString().split(".")[1].length)),
                        r > l[u][g] && l[u][g] < 0 && (r = l[u][g])) : a.hasNullValues = !0
                }
                return {
                    minY: r,
                    maxY: n,
            ...
            value: function() {
                ...
                if (t.isMultipleYAxis)
                    for (var a = 0; a < t.series.length; a++) {
                        ...
                        t.minYArr.push(n.minY),
                        t.maxYArr.push(n.maxY),
                        s = n.lowestY
                    }
                ...
                e.chart.stacked) {
                    for (var o = [], l = [], h = 0; h < t.series[t.maxValsInArrayIndex].length; h++)
                        for (var c = 0, u = 0, g = 0; g < t.series.length; g++)
                            null !== t.series[g][h] && d.isNumber(t.series[g][h]) && (t.series[g][h] > 0 ? c = c + parseFloat(t.series[g][h]) + 1e-4 : u += parseFloat(t.series[g][h])),
                            g === t.series.length - 1 && (o.push(c),
                            l.push(u));
                    for (var f = 0; f < o.length; f++)
                        t.maxY = Math.max(t.maxY, o[f]),
                        t.minY = Math.min(t.minY, l[f])
                }
                if (("line" === e.chart.type || "area" === e.chart.type || "candlestick" === e.chart.type) && t.minY === Number.MIN_VALUE && s !== Number.MAX_SAFE_INTEGER) {
                    var p = t.maxY - s;
                    s >= 0 && s <= 10 && (p = 0),
                    t.minY = s - 5 * p / 100,
                    t.maxY = t.maxY + 5 * p / 100 + .01
                }
                e.yaxis.map(function(e, s) {
                    void 0 !== e.max && "number" == typeof e.max && (t.maxYArr[s] = e.max,
                    t.maxY = i[0].max),
                    void 0 !== e.min && "number" == typeof e.min && (t.minYArr[s] = e.min,
                    t.minY = i[0].min)
                }),
                this.isBarHorizontal && (void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (t.minY = e.xaxis.min),
            ...
            key: "setXRange",
            value: function() {
                var t, e = this.w.globals, i = this.w.config, s = "numeric" === i.xaxis.type || "datetime" === i.xaxis.type || "category" === i.xaxis.type && !e.noLabelsProvided;
                if (e.isXNumeric)
                    for (var a = 0; a < e.series.length; a++)
                        if (e.labels[a])
                            for (var n = 0; n < e.labels[a].length; n++)
                                null !== e.labels[a][n] && d.isNumber(e.labels[a][n]) && (e.maxX = Math.max(e.maxX, e.labels[a][n]),
                ...
                e.minX = 1,
                e.initialminX = 1),
                (e.comboChartsHasBars || "candlestick" === i.chart.type || "bar" === i.chart.type && "category" !== i.xaxis.type) && "category" !== i.xaxis.type) {
                ...
                (e.isXNumeric || e.noLabelsProvided) && (void 0 === i.xaxis.tickAmount ? (t = Math.round(e.svgWidth / 150),
                ...
                if (e.minX === e.maxX)
                    if ("datetime" === i.xaxis.type) {
                        ...
                        e.minX = new Date(l).getTime();
                        var h = new Date(e.maxX);
                        h.setDate(h.getDate() + 2),
                        e.maxX = new Date(h).getTime()
                    } else
                    ...
                    for (var e = 0; e < t.series.length; e++)
                        if (void 0 !== t.seriesZ[e])
                            for (var i = 0; i < t.seriesZ[e].length; i++)
                                null !== t.seriesZ[e][i] && d.isNumber(t.seriesZ[e][i]) && (t.maxZ = Math.max(t.maxZ, t.seriesZ[e][i]),
      ...
      , B = function() {
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                "left" === e.align ? (s = 10,
                n = "start") : "right" === e.align && (s = t.globals.svgWidth - 10,
                n = "end"),
      ...
      , V = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                this.isBarHorizontal ? this.yAxisWidth = i.globals.yLabelsCoords[0].width + i.globals.yTitleCoords[0].width + 15 : this.yAxisWidth = this.getTotalYAxisWidth(),
                i.globals.isMultipleYAxis || (this.yAxisWidth < i.config.yaxis[0].labels.minWidth && (this.yAxisWidth = i.config.yaxis[0].labels.minWidth),
            ...
            value: function(t) {
                ...
                this.isBarHorizontal && (i.rotateXLabels = !1,
                ...
                this.isBarHorizontal || this.setGridXPosForDualYAxis(n, s),
                new D(this.ctx).setYAxisXPosition(s, n)
            }
        }, {
            ...
            value: function(t) {
                ...
                var a = 10
                  , n = 0;
                if ("pie" === e.config.chart.type || "donut" === e.config.chart.type ? (a += e.config.plotOptions.pie.offsetY,
                n += e.config.plotOptions.pie.offsetX) : "radialBar" === e.config.chart.type && (a += e.config.plotOptions.radialBar.offsetY,
            ...
            value: function() {
                ...
                return t.globals.yLabelsCoords.map(function(a, n) {
                    ...
                    a.width > 0 && !r ? (e = e + a.width + i,
                    s(n) && (e = e - a.width - i)) : e += r || !t.config.yaxis[n].show ? 0 : 5
                }),
            ...
            value: function() {
                var t, e = this.w, i = e.globals.timelineLabels.slice().map(function(t) {
                    return t.value
                ...
                return 1.05 * (t = new f(this.ctx).getTextRects(s, e.config.xaxis.labels.style.fontSize)).width * i.length > e.globals.gridWidth && 0 !== e.config.xaxis.labels.rotate && (e.globals.overlappingXLabels = !0),
                t
            }
        }, {
            ...
            value: function() {
                ...
                if (e.globals.timelineLabels.length > 0) {
                    ...
                    (t = {
                        width: l.width,
                        height: l.height
                    }).width * i.length > e.globals.svgWidth - a - this.yAxisWidth && 0 !== e.config.xaxis.labels.rotate ? this.isBarHorizontal || (e.globals.rotateXLabels = !0,
                    l = o.getTextRects(n, e.config.xaxis.labels.style.fontSize, e.config.xaxis.labels.style.fontFamily, "rotate(".concat(e.config.xaxis.labels.rotate, " 0 0)"), !1),
                    t.height = l.height / 1.66) : e.globals.rotateXLabels = !1
                }
            ...
            value: function(t) {
                ...
                if (null !== n && !a) {
                    ...
                    i = r.width,
                    s = e.globals.axisCharts ? r.height + 5 : r.height
                }
                return {
                    width: i,
                    height: s
      ...
      , _ = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                r < .005 ? s.globals.disableZoomIn = !0 : r > 5e4 && (s.globals.disableZoomOut = !0);
                ...
                return m.filter(function(t) {
                    ...
                    m.length > a && (e = Math.floor(m.length / a));
                    var r = !1
                      , o = !1;
            ...
            value: function(t) {
                ...
                e.globals.timelineLabels = s.slice(),
                new V(this.ctx).plotCoords()
            }
        }, {
            ...
            value: function(t) {
                ...
                for (var x = o + 1, b = l, m = 0, v = 1; m < r; m++,
                v++) {
                    0 === (x = d.monthMod(x)) ? (c = "year",
                    u += 1) : c = "month";
            ...
            value: function(t) {
                var e = t.firstVal
                  ...
                  , l = "hour"
                  , h = function(t, e) {
                    return t > o.determineDaysOfMonths(e + 1, a) && (x = 1,
                    e += 1),
                    {
                        month: e,
                        date: x
            ...
            value: function(t) {
                ...
                return t.map(function(t) {
                    ...
                    if (void 0 === i.config.xaxis.labels.format) {
                        ...
                        s = a.formatDate(r, i.config.xaxis.labels.format);
                    return {
                        dateString: n,
                        position: t.position,
                        value: s,
        ...
        return s(t, [{
            ...
            value: function() {
                var t = this.w.globals
                  , e = this.w.config
                  , i = e.chart.type;
                t.axisCharts = ["line", "area", "bar", "candlestick", "radar", "scatter", "bubble", "heatmap"].indexOf(i) > -1,
            ...
            value: function(t, e) {
                ...
                a.series.map(function(e, s) {
                    if (void 0 !== t[s].type) {
                        if ("column" === t[s].type || "bar" === t[s].type)
                            ...
                            l.series.push(e),
                            l.i.push(s);
                        else if ("area" === t[s].type)
                            r.series.push(e),
                            r.i.push(s);
                        else if ("line" === t[s].type)
                            n.series.push(e),
                            n.i.push(s);
                        else if ("scatter" === t[s].type)
                            o.series.push(e),
                            o.i.push(s);
                        else {
                ...
                var c = new O(this.ctx,e)
                  ...
                  , p = [];
                if (a.comboCharts) {
                    if (r.series.length > 0 && p.push(c.draw(r.series, "area", r.i)),
                    l.series.length > 0)
                    ...
                    if (n.series.length > 0 && p.push(c.draw(n.series, "line", n.i)),
                    ...
                    case "bar":
                        if (s.chart.stacked)
                            p = new M(this.ctx,e).draw(a.series);
                        else
                            p = new z(this.ctx,e).draw(a.series);
                        break;
                    case "candlestick":
            ...
            value: function() {
                ...
                if ("%" === s ? d.isNumber(i[0]) && (0 === i[0].width && (i = d.getDimensions(this.el.parentNode)),
                t.svgWidth = i[0] * parseInt(e.chart.width) / 100) : "px" !== s && "" !== s || (t.svgWidth = parseInt(e.chart.width)),
            ...
            value: function() {
                if (this.w.config.yaxis.constructor === Array && this.w.config.yaxis.length > 1)
                    return this.w.config.chart.stacked = !1,
                    this.w.globals.isMultipleYAxis = !0,
                    !0
            }
        }, {
            ...
            value: function() {
                ...
                if (void 0 !== t[e].data && t[e].data.length > 0 && null !== t[e].data[0] && void 0 !== t[e].data[0].x && null !== t[e].data[0])
                    return !0
            }
        }, {
            key: "isFormat2DArray",
            value: function() {
                var t = this.w.config.series.slice()
                  , e = new B(this.ctx).getActiveConfigSeriesIndex();
                if (void 0 !== t[e].data && t[e].data.length > 0 && void 0 !== t[e].data[0] && null !== t[e].data[0] && t[e].data[0].constructor === Array)
                    return !0
            }
        }, {
            ...
            value: function(t, e) {
                for (var i = this.w.config, s = this.w.globals, a = 0; a < t[e].data.length; a++)
                    if (void 0 !== t[e].data[a][1] && (Array.isArray(t[e].data[a][1]) && 4 === t[e].data[a][1].length ? this.twoDSeries.push(d.parseNumber(t[e].data[a][1][3])) : this.twoDSeries.push(d.parseNumber(t[e].data[a][1]))),
                    "datetime" === i.xaxis.type) {
                        var n = new Date(t[e].data[a][0]);
                        n = new Date(n).getTime(),
                        this.twoDSeriesX.push(n)
                    } else
                        this.twoDSeriesX.push(t[e].data[a][0]);
            ...
            value: function(t, e) {
                for (var i = this.w.config, s = this.w.globals, a = this.w.config.series.slice(), n = new T(this.ctx), r = 0; r < t[e].data.length; r++) {
                    ...
                    o || l ? o ? "datetime" === i.xaxis.type ? this.twoDSeriesX.push(n.parseDate(t[e].data[r].x)) : (this.fallbackToCategory = !0,
                    this.twoDSeriesX.push(t[e].data[r].x)) : "datetime" === i.xaxis.type ? this.twoDSeriesX.push(n.parseDate(t[e].data[r].x.toString())) : this.twoDSeriesX.push(parseFloat(t[e].data[r].x)) : this.twoDSeriesX.push(t[e].data[r].x)
                }
                if (a[e].data[0] && void 0 !== a[e].data[0].z) {
                    for (var h = 0; h < a[e].data.length; h++)
                        this.threeDSeries.push(a[e].data[h].z);
                    s.isDataXYZ = !0
                }
            }
        }, {
            ...
            value: function(t, e) {
                var i = this.w.globals
                  , s = {};
                return this.isFormat2DArray() ? s = this.handleCandleStickDataFormat("array", t, e) : this.isFormatXY() && (s = this.handleCandleStickDataFormat("xy", t, e)),
                ...
                for (var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.ctx, s = this.w.config, a = this.w.globals, n = new T(i), r = 0; r < e.length; r++) {
                    ...
                    if (this.isMultiFormat())
                        ...
                        if ("datetime" === s.xaxis.type) {
                            ...
                            h.length > 0 && (this.twoDSeriesX = h,
                            a.seriesX.push(this.twoDSeriesX))
                        }
                        a.labels.push(this.twoDSeriesX),
                        a.series.push(t[r].data)
                    }
                    a.seriesZ.push(this.threeDSeries),
                    void 0 !== t[r].name ? a.seriesNames.push(t[r].name) : a.seriesNames.push("series-" + parseInt(r + 1))
                }
                return this.w
            }
        }, {
            ...
            value: function(t) {
                ...
                if (e.xaxis.categories.length > 0)
                    ...
                    "category" === e.xaxis.type && (i.isXNumeric = !1)
                }
            }
        }, {
            key: "parseData",
            ...
            value: function() {
                ...
                if (e.globals.axisCharts) {
                    if ("back" === e.config.xaxis.crosshairs.position)
                        new E(this.ctx).drawXCrosshairs();
                    if ("back" === e.config.yaxis[0].crosshairs.position)
                        new E(this.ctx).drawYCrosshairs();
            ...
            key: "drawAxis",
            value: function(t, e) {
                var i, s, a = this.w.globals, n = this.w.config, r = new R(this.ctx), o = new D(this.ctx);
                a.axisCharts && "radar" !== t && ("bar" === t && n.plotOptions.bar.horizontal ? (s = o.drawYaxisInversed(0),
                i = r.drawXaxisInversed(0),
                a.dom.elGraphical.add(i),
                a.dom.elGraphical.add(s)) : (i = r.drawXaxis(),
                a.dom.elGraphical.add(i),
                n.yaxis.map(function(t, i) {
                    -1 === a.ignoreYAxisIndexes.indexOf(i) && (s = o.drawYaxis(e, i),
                    a.dom.Paper.add(s))
                })));
    ...
    function Z(t, e) {
        ...
        U._immediateFn(function() {
            ...
            if (null !== i) {
                ...
                (1 === t._state ? $ : J)(e.promise, t._value)
        })) : t._deferreds.push(e)
    }
    function $(t, e) {
        try {
    ...
    var et, it, st = function() {
        ...
        return s(t, [{
            ...
            value: function() {
                for (var t, e = this.w, i = new f(this.ctx), s = e.config.grid.strokeDashArray, a = i.group({
                    class: "apexcharts-grid"
                }), n = 8, r = 0; r < e.globals.series.length && (void 0 !== e.globals.yAxisScale[r] && (n = e.globals.yAxisScale[r].result.length - 1),
                !(n > 2)); r++)
                    ;
                if (!(!e.config.plotOptions.bar.horizontal || "bar" !== e.config.chart.type)) {
                    if (t = n,
                    e.config.grid.xaxis.lines.show || e.config.xaxis.axisTicks.show)
                        for (var o, l = e.globals.padHorizontal, h = e.globals.gridHeight, c = 0; c < t + 1 && (o = l = l + e.globals.gridWidth / t + .3,
                        c !== t - 1); c++) {
                    ...
                    if (t = this.xaxisLabels.length,
                    e.config.grid.xaxis.lines.show || e.config.xaxis.axisTicks.show) {
                        var m, v = e.globals.padHorizontal, y = e.globals.gridHeight;
                        if (e.globals.timelineLabels.length > 0)
                            for (var w = 0; w < t; w++) {
                                if (v = this.xaxisLabels[w].position,
                                m = this.xaxisLabels[w].position,
                            ...
                            for (var A = t, S = 0; S < A; S++) {
                                var C = A;
                                if (e.globals.isXNumeric && "bar" !== e.config.chart.type && (C -= 1),
                                m = v += e.globals.gridWidth / C,
                                S === C - 1)
                                    break;
                                if (e.config.grid.xaxis.lines.show) {
            ...
            value: function(t, e, i) {
                ...
                if (void 0 !== s.config.grid.row.colors && s.config.grid.row.colors.length > 0)
                    for (var n = 0, r = s.globals.gridHeight / i, o = s.globals.gridWidth, l = 0, h = 0; l < i; l++,
                    h++) {
                ...
                if (void 0 !== s.config.grid.column.colors && s.config.grid.column.colors.length > 0)
                    for (var u = s.globals.padHorizontal, g = s.globals.padHorizontal + s.globals.gridWidth / e, p = s.globals.gridHeight, x = 0, b = 0; x < e; x++,
                    b++) {
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                for (var n = t.globals.legendFormatter, r = 0; r <= i.length - 1; r++) {
                    ...
                    y.borderColor = Array.isArray(b) ? b[r] : b,
                    y.borderRadius = Array.isArray(m) ? parseFloat(m[r]) + "px" : parseFloat(m) + "px",
                    t.config.legend.markers.customHTML && (Array.isArray(t.config.legend.markers.customHTML) ? c.innerHTML = t.config.legend.markers.customHTML[r]() : c.innerHTML = t.config.legend.markers.customHTML()),
                    f.setAttrs(c, {
                        rel: r + 1,
                        "data:collapsed": l
                    }),
                    ...
                    k.classList.add("apexcharts-legend-text"),
                    k.innerHTML = o;
                    ...
                    if (!t.config.legend.showForZeroSeries)
                        0 === S.getSeriesTotalByIndex(r) && S.seriesHaveSameValues(r) && !S.isSeriesNull(r) && -1 === t.globals.collapsedSeriesIndices.indexOf(r) && w.classList.add("apexcharts-hidden-zero-series");
                    t.config.legend.showForNullSeries || S.isSeriesNull(r) && -1 === t.globals.collapsedSeriesIndices.indexOf(r) && w.classList.add("apexcharts-hidden-null-series"),
                    ...
                    w.style.margin = "".concat(t.config.legend.itemMargin.horizontal, "px ").concat(t.config.legend.itemMargin.vertical, "px"),
            ...
            value: function(t, e) {
                ...
                s.style.bottom = 10 + i.config.legend.offsetY + "px") : "right" === i.config.legend.position && (s.style.left = "auto",
            ...
            value: function() {
                ...
                var e = this.getLegendBBox()
                  ...
                  , n = 0;
                "bottom" === t.config.legend.position ? n = -e.clwh / 1.8 : "top" === t.config.legend.position && (n = s.height + a.height + t.config.title.margin + t.config.subtitle.margin - 15),
            ...
            value: function(t) {
                if (t.target.classList.contains("apexcharts-legend-text") || t.target.classList.contains("apexcharts-legend-marker")) {
                    ...
                    "function" == typeof a && t.target.classList.contains("apexcharts-legend-marker") && (a(this.ctx, e, this.w),
            ...
            value: function() {
                ...
                t.globals.collapsedSeries.length > 0) {
                    for (var i = t.globals.risingSeries.slice(), s = t.config.series.slice(), a = 0; a < t.globals.collapsedSeries.length; a++) {
                        ...
                        -1 !== n && (t.globals.axisCharts ? s[n].data = t.globals.collapsedSeries.slice()[a].data.slice() : s[n] = t.globals.collapsedSeries.slice()[a].data,
                        i.push(n))
                    }
            ...
            value: function(t, e) {
                ...
                if (i.globals.axisCharts || "radialBar" === i.config.chart.type) {
                    ...
                    i.globals.axisCharts ? (s = i.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(t, "']")),
                    a = parseInt(s.getAttribute("data:realIndex"))) : (s = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']")),
                    a = parseInt(s.getAttribute("rel")) - 1),
                    e) {
                        if (i.globals.collapsedSeries.length > 0)
                            for (var n = 0; n < i.globals.collapsedSeries.length; n++)
                                i.globals.collapsedSeries[n].index === a && (i.globals.axisCharts ? (i.config.series[a].data = i.globals.collapsedSeries[n].data.slice(),
                                i.globals.collapsedSeries.splice(n, 1),
                                i.globals.collapsedSeriesIndices.splice(n, 1),
                                i.globals.risingSeries.push(a)) : (i.config.series[a] = i.globals.collapsedSeries[n].data,
                                i.globals.collapsedSeries.splice(n, 1),
                                i.globals.collapsedSeriesIndices.splice(n, 1),
                    ...
                    var n = new y({})
                      , r = function() {
                        ...
                        if (r > s) {
                            ...
                            t = d.extend(i.config, o),
                            e.overrideResponsiveOptions(t)
                        } else
                            for (var l = 0; l < a.length; l++)
                                r < a[l].breakpoint && (t = d.extend(n, t),
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                t.config.theme.monochrome.enabled) {
                    ...
                    for (var a = t.config.theme.monochrome.color, n = 1 / (s / t.config.theme.monochrome.shadeIntensity), r = t.config.theme.monochrome.shadeTo, o = 0, l = 0; l < s; l++) {
                        var h = void 0;
                        "dark" === r ? (h = e.shadeColor(-1 * o, a),
                        o += n) : (h = e.shadeColor(o, a),
                        o += n),
                        i.push(h)
                    }
                ...
                void 0 === t.config.plotOptions.radar.polygons.fill.colors ? t.globals.radarPolygons.fill.colors = ["#fff"] : t.globals.radarPolygons.fill.colors = t.config.plotOptions.radar.polygons.fill.colors,
            ...
            value: function(t, e) {
                ...
                if ((i = null === i && ("bar" === s.config.chart.type && s.config.plotOptions.bar.distributed || "heatmap" === s.config.chart.type && s.config.plotOptions.heatmap.colorScale.inverse)) && (a = s.globals.series[0].length * s.globals.series.length),
                t.length < a)
                    for (var n = a - t.length, r = 0; r < n; r++)
                        t.push(t[r])
            }
        }, {
            key: "predefined",
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                for (var s = i.allTooltipSeriesGroups, a = 0; a < s.length; a++)
                    "enable" === t ? (s[a].classList.add("active"),
                    s[a].style.display = e.config.tooltip.items.display) : (s[a].classList.remove("active"),
        ...
        return s(t, [{
            ...
            key: "printLabels",
            value: function(t) {
                var e, i = t.i, s = t.j, a = t.values, n = t.ttItems, r = t.shared, o = this.w, l = a.xVal, h = a.zVal, c = a.xAxisTTVal, d = "", u = o.globals.colors[i];
            ...
            value: function(t) {
                ...
                return void 0 !== i.globals.ttVal ? Array.isArray(i.globals.ttVal) ? (s = i.globals.ttVal[t] && i.globals.ttVal[t].formatter,
                e = i.globals.ttVal[t] && i.globals.ttVal[t].title && i.globals.ttVal[t].title.formatter) : (s = i.globals.ttVal.formatter,
                "function" == typeof i.globals.ttVal.title.formatter && (e = i.globals.ttVal.title.formatter)) : e = i.config.tooltip.y.title.formatter,
                "function" != typeof s && (s = i.globals.yLabelFormatters[0] ? i.globals.yLabelFormatters[0] : function(t) {
                    return t
                }
                ),
            ...
            value: function(t) {
                var e = t.t
                  ...
                  , g = null;
                g = i[e].children,
                o.config.tooltip.fillSeriesColor && (i[e].style.backgroundColor = r,
                ...
                null !== u) && (i[e].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = o.config.tooltip.z.title,
            ...
            value: function(t) {
                ...
                null === i ? o = s.globals.series[e] : s.globals.isXNumeric ? (n = a[e][i],
                0 === a[e].length && (n = a[this.tooltipUtil.getFirstActiveXArray(a)][i])) : n = void 0 !== s.globals.labels[i] ? s.globals.labels[i] : "";
                var c = n;
                ...
                return void 0 !== s.config.tooltip.x.formatter && (n = s.globals.ttKeyFormatter(c, l)),
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                if (null !== e && (n = s.globals.gridWidth / r * e),
                "tickWidth" === s.config.xaxis.crosshairs.width || "barWidth" === s.config.xaxis.crosshairs.width ? n + i.xcrosshairsWidth > s.globals.gridWidth && (n = s.globals.gridWidth - i.xcrosshairsWidth) : null !== e && (n += s.globals.gridWidth / r / 2),
                n < 0 && (n = 0),
                n > s.globals.gridWidth && (n = s.globals.gridWidth),
                null !== a && (a.setAttribute("x", n),
                a.setAttribute("x1", n),
                a.setAttribute("x2", n),
                ...
                i.blxaxisTooltip) {
                    var o = n;
                    "tickWidth" !== s.config.xaxis.crosshairs.width && "barWidth" !== s.config.xaxis.crosshairs.width || (o = n + i.xcrosshairsWidth / 2),
            ...
            value: function(t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null
                  ...
                  , l = parseInt(t) + o + 5
                  , h = parseInt(e) + o / 2;
                if (l > s.globals.gridWidth / 2 && (l = l - r.ttWidth - o - 15),
                ...
                l = d.x,
                h = d.y,
                isNaN(l) || (l += s.globals.translateX,
                n.style.left = l + "px",
                n.style.top = h + "px")
            }
        }, {
            ...
            value: function(t, e, i) {
                var s = this.w;
                return t.ttHeight + i > s.globals.gridHeight && (i = s.globals.gridHeight - t.ttHeight + s.globals.translateY),
                i < 0 && (i = 0),
                {
                    x: e,
                    y: i
            ...
            value: function(t, e) {
                ...
                if (i.globals.markers.size[t] > 0)
                    for (var a = i.globals.dom.baseEl.querySelectorAll(" .apexcharts-series[data\\:realIndex='".concat(t, "'] .apexcharts-marker")), n = 0; n < a.length; n++)
                        parseInt(a[n].getAttribute("rel")) === e && (s.marker.resetPointsSize(),
            ...
            value: function(t) {
                var e, i = this.w, s = this.ttCtx, a = i.globals.dom.baseEl.querySelector(".apexcharts-bar-series .apexcharts-series[rel='1'] path[j='".concat(t, "'], .apexcharts-candlestick-series .apexcharts-series[rel='1'] path[j='").concat(t, "']")), n = a ? parseFloat(a.getAttribute("cx")) : 0, r = a ? parseFloat(a.getAttribute("barWidth")) : 0;
                i.globals.isXNumeric ? n -= r / 2 : (n = s.xAxisTicksPositions[t - 1] + s.dataPointsDividedWidth / 2,
                isNaN(n) && (n = s.xAxisTicksPositions[t] - s.dataPointsDividedWidth / 2));
                var o = s.getElGrid().getBoundingClientRect();
                if (e = s.e.clientY - o.top - s.tooltipRect.ttHeight / 2,
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                var s = e.getAttribute("cx")
                  , a = e.getAttribute("cy");
                if (this.tooltipPosition.moveXCrosshairs(s),
                !this.fixedTooltip) {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                if (s.target.classList.contains("apexcharts-marker")) {
                    ...
                    if (i = parseInt(a.paths.getAttribute("rel")),
            ...
            value: function(t) {
                var e, i = t.e, s = t.opt, a = this.w, n = this.ttCtx, r = n.getElTooltip(), o = 0, l = 0, h = 0, c = 0;
                if (n.isBarHorizontal && n.hasBars() || !a.config.tooltip.shared) {
                    ...
                    a.globals.comboCharts || a.config.tooltip.shared || (o /= 2);
                if (isNaN(h) && (h = a.globals.svgHeight - n.tooltipRect.ttHeight),
                l + n.tooltipRect.ttWidth > a.globals.gridWidth ? l -= n.tooltipRect.ttWidth : l < 0 && (l += n.tooltipRect.ttWidth),
                n.w.config.tooltip.followCursor) {
                    var u = n.getElGrid().getBoundingClientRect();
                    h = n.e.clientY - u.top
                }
                null === n.tooltip && (n.tooltip = a.globals.dom.baseEl.querySelector(".apexcharts-tooltip")),
                a.config.tooltip.shared || (a.globals.comboChartsHasBars ? n.tooltipPosition.moveXCrosshairs(o + e / 2) : n.tooltipPosition.moveXCrosshairs(o)),
                !n.fixedTooltip && (!a.config.tooltip.shared || n.isBarHorizontal && n.hasBars()) && (r.style.left = l + a.globals.translateX + "px",
                n.tooltipRect.ttHeight + h > a.globals.gridHeight ? (h = a.globals.gridHeight - n.tooltipRect.ttHeight + a.globals.translateY,
                r.style.top = h + "px") : r.style.top = h + a.globals.translateY - n.tooltipRect.ttHeight / 2 + "px")
            }
        }, {
            key: "getBarTooltipXY",
            value: function(t) {
                ...
                if (c.contains("apexcharts-bar-area") || c.contains("apexcharts-candlestick-area")) {
                    ...
                    s.config.tooltip.followCursor ? s.config.plotOptions.bar.horizontal ? (o = m - g.left + 15,
                    l = b - n.dataPointsDividedHeight + f / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? x - p / 2 : x - n.dataPointsDividedWidth + p / 2,
                    l = e.clientY - g.top - n.tooltipRect.ttHeight / 2 - 15) : s.config.plotOptions.bar.horizontal ? ((o = x) < n.xyRatios.baseLineInvertedY && (o = x - n.tooltipRect.ttWidth),
                    l = b - n.dataPointsDividedHeight + f / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? x - p / 2 : x - n.dataPointsDividedWidth + p / 2,
                    l = b)
                }
                return {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                if ((e.globals.comboCharts && !e.config.tooltip.shared || e.config.tooltip.intersect && !e.config.tooltip.shared || "bar" === e.config.chart.type && !e.config.tooltip.shared) && (this.showOnIntersect = !0),
                ...
                e.globals.collapsedSeries.length !== e.globals.series.length) {
                    ...
                    this.tooltipTitle.style.fontFamily = e.config.tooltip.style.fontFamily || e.config.chart.fontFamily,
                    ...
                    (e.globals.xyCharts || e.globals.comboCharts) && e.config.tooltip.shared && (a = this.showOnIntersect ? 1 : e.globals.series.length),
            ...
            value: function() {
                ...
                if (t.globals.axisCharts && ("area" === e || "line" === e || "scatter" === e || "bubble" === e ? r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:longestSeries='true'] .apexcharts-marker") : s ? r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area", ".apexcharts-series .apexcharts-candlestick-area") : "heatmap" === e ? r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap") : "radar" === e && (r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-marker")),
                r && r.length))
                    for (var c = 0; c < r.length; c++)
                        o.push(r[c].getAttribute("cy")),
                        l.push(r[c].getAttribute("cx"));
                if (t.globals.xyCharts && !this.showOnIntersect || t.globals.comboCharts && !this.showOnIntersect || s && this.hasBars() && t.config.tooltip.shared)
            ...
            value: function() {
                ...
                return t.config.tooltip.fixed.position.toLowerCase().indexOf("right") > -1 && (n = n + t.globals.svgWidth - s + 10),
                t.config.tooltip.fixed.position.toLowerCase().indexOf("bottom") > -1 && (r = r + t.globals.svgHeight - a - 10),
                e.style.left = n + "px",
                e.style.top = r + "px",
                {
                    x: n,
            ...
            value: function(t, e) {
                ...
                a.globals.axisCharts && (a.globals.minX === -1 / 0 && a.globals.maxX === 1 / 0 || 0 === a.globals.dataPoints) || (s.length ? s.forEach(function(s) {
            ...
            value: function(t) {
                ...
                i.e = a,
                !i.hasBars() || n.globals.comboCharts || i.isBarShared) || n.config.tooltip.onDatasetHover.highlightDataSeries && new B(e).toggleSeriesOnHover(a, a.target.parentNode);
            ...
            value: function(t) {
                var e, i, s, a = t.e, n = t.opt, r = this.w, o = null, l = n.elGrid.getBoundingClientRect(), h = "touchmove" === a.type ? a.touches[0].clientX : a.clientX, c = "touchmove" === a.type ? a.touches[0].clientY : a.clientY;
                if (this.clientY = c,
                this.clientX = h,
                c < l.top || c > l.top + l.height)
                    ...
                    if ("bar" === r.config.chart.type && this.isBarHorizontal && this.hasBars() && (g = !1),
                    "mousemove" === a.type || "touchmove" === a.type) {
                        if (null !== u && u.classList.add("active"),
                        ...
                        g && !this.showOnIntersect) {
                            ...
                            if (null !== f) {
                                if (null === r.globals.series[f][e])
                                    return void n.tooltipEl.classList.remove("active");
                        ...
                        "mouseout" !== a.type && "touchend" !== a.type || this.handleMouseOut(n)
                }
            }
        }, {
            ...
            value: function(t) {
                ...
                "radialBar" === a.config.chart.type ? h = a.globals.dom.baseEl.querySelector(".apexcharts-radialbar") : (h = a.globals.dom.baseEl.querySelector(".apexcharts-pie"),
            ...
            value: function(t, e, i, s) {
                ...
                if (a) {
                    ...
                    this.hasBars() && (this.barSeriesHeight = this.tooltipUtil.getBarsHeight(l),
                    this.barSeriesHeight > 0)) {
                        var h = new f(this.ctx)
                          , c = n.globals.dom.Paper.select(".apexcharts-bar-area[j='".concat(i, "']"));
                        this.deactivateHoverFilter(),
                        this.tooltipPosition.moveStickyTooltipOverBars(i);
                        for (var d = 0; d < c.length; d++)
                            h.pathMouseEnter(c[d])
                    }
                } else
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                this.ctx._updateOptions({
                    xaxis: i
                }, !1, this.w.config.chart.animations.dynamicAnimation.enabled),
                this.zoomCallback({
                    min: t,
                    max: e
                })
            ...
            key: "destroy",
            value: function() {
                this.elZoomReset && (this.elZoomReset.removeEventListener("click", this.handleZoomReset.bind(this)),
        ...
        s(i, [{
            ...
            value: function(t) {
                ...
                "x" === s.config.chart.selection.type ? this.slDraggableRect = this.selectionRect.draggable({
                    minX: 0,
                    minY: 0,
            ...
            value: function(t, e) {
                ...
                a.enablePanning()) : this.shiftWasPressed && (a.enableZooming(),
                ...
                !(e.target.classList.contains("apexcharts-selection-rect") || e.target.parentNode.classList.contains("apexcharts-toolbar"))) {
                    if (s.clientX = "touchmove" === e.type || "touchstart" === e.type ? e.touches[0].clientX : "touchend" === e.type ? e.changedTouches[0].clientX : e.clientX,
                    ...
                    if (("mousemove" === e.type && 1 === e.which || "touchmove" === e.type) && (s.dragged = !0,
                    i.globals.panEnabled ? (i.globals.selection = null,
                    s.w.globals.mousedown && s.panDragging({
                        context: s,
                        zoomtype: n,
                        xyRatios: t
                    ...
                    "mouseup" === e.type || "touchend" === e.type) {
                        ...
                        s.w.globals.mousedown && (s.endX = s.clientX - o.left,
                        s.endY = s.clientY - o.top,
                        s.dragX = Math.abs(s.endX - s.startX),
                        s.dragY = Math.abs(s.endY - s.startY),
                        (i.globals.zoomEnabled || i.globals.selectionEnabled) && s.selectionDrawn({
                            context: s,
                            zoomtype: n
                        })),
            ...
            value: function(t) {
                var e = t.context
                  ...
                  , d = 0
                  , u = {};
                return (Math.abs(l + r) > s.globals.gridWidth || a.clientX - n.left < 0) && (a.hideSelectionRect(this.zoomRect),
                a.dragged = !1,
            ...
            value: function(t, e) {
                var i = this
                  ...
                  , r = 0;
                "resizing" === t && (r = 30),
                "function" == typeof s.config.chart.events.selection && (clearTimeout(this.w.globals.selectionResizeTimer),
            ...
            value: function(t) {
                ...
                a.dragged && (a.dragX > 10 || a.dragY > 10) && h !== c)
                    if (s.globals.zoomEnabled) {
                        ...
                        s.globals.zoomed || (s.globals.lastXAxis = d.clone(s.config.xaxis),
                        s.globals.lastYAxis = d.clone(s.config.yaxis));
                        var p = {
                            min: h,
                            max: c
                        };
                        ...
                        a.ctx._updateOptions({
                            xaxis: p,
                            yaxis: f
                        }, !1, a.w.config.chart.animations.dynamicAnimation.enabled),
                        ...
                        "function" == typeof s.config.chart.events.selection && s.config.chart.events.selection(a.ctx, {
                            xaxis: m,
                            yaxis: v
                        })
                    }
            ...
            key: "panDragging",
            value: function(t) {
                var e, i = t.context, s = (t.zoomtype,
                this.w), a = i;
            ...
            value: function(t, e, i) {
                ...
                "left" === t ? (e = s.globals.minX + s.globals.gridWidth / 15 * a.xRatio,
                i = s.globals.maxX + s.globals.gridWidth / 15 * a.xRatio) : "right" === t && (e = s.globals.minX - s.globals.gridWidth / 15 * a.xRatio,
                i = s.globals.maxX - s.globals.gridWidth / 15 * a.xRatio),
                (e < s.globals.initialminX || i > s.globals.initialmaxX) && (e = s.globals.minX,
                i = s.globals.maxX);
                var r = {
                    min: e,
                    max: i
                ...
                "function" == typeof s.config.chart.events.scrolled && s.config.chart.events.scrolled(this.ctx, {
                    xaxis: {
                        min: e,
                        max: i
                    }
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                n = "start") : "right" === i.align && (s = e.globals.svgWidth - 10,
                n = "end"),
                s += i.offsetX,
    ...
    it = function(e, i) {
        var s = (void 0 !== this ? this : e).SVG = function(t) {
            if (s.supported)
                return t = new s.Doc(t),
                s.parser.draw || s.prepare(),
                t
        }
        ;
        if (s.ns = "http://www.w3.org/2000/svg",
        ...
        ,
        s.adopt = function(t) {
            return t ? t.instance ? t.instance : ((i = "svg" == t.nodeName ? t.parentNode instanceof e.SVGElement ? new s.Nested : new s.Doc : "linearGradient" == t.nodeName ? new s.Gradient("linear") : "radialGradient" == t.nodeName ? new s.Gradient("radial") : s[d(t.nodeName)] ? new (s[d(t.nodeName)]) : new s.Element(t)).type = t.nodeName,
            i.node = t,
            t.instance = i,
        ...
        s.Color = function(e) {
            ...
            this.g = 0,
            this.b = 0,
            e) && ("string" == typeof e ? s.regex.isRgb.test(e) ? (i = s.regex.rgb.exec(e.replace(s.regex.whitespace, "")),
            this.r = parseInt(i[1]),
            this.g = parseInt(i[2]),
            this.b = parseInt(i[3])) : s.regex.isHex.test(e) && (i = s.regex.hex.exec(4 == (a = e).length ? ["#", a.substring(1, 2), a.substring(1, 2), a.substring(2, 3), a.substring(2, 3), a.substring(3, 4), a.substring(3, 4)].join("") : a),
        ...
        s.extend(s.Color, {
            ...
            morph: function(t) {
                return this.destination = new s.Color(t),
                this
            },
            at: function(t) {
        ...
        s.Color.test = function(t) {
            return t += "",
            s.regex.isHex.test(t) || s.regex.isRgb.test(t)
        }
        ,
        ...
        s.extend(s.PointArray, {
            ...
            parse: function(t) {
                ...
                Array.isArray(t)) {
                    ...
                    t = t.trim().split(s.regex.delimiter).map(parseFloat);
                t.length % 2 != 0 && t.pop();
            ...
            bbox: function() {
                return s.parser.draw || s.prepare(),
        ...
        s.extend(s.PathArray, {
            ...
            move: function(t, e) {
                ...
                !isNaN(t) && !isNaN(e))
                    for (var s, a = this.value.length - 1; a >= 0; a--)
                        "M" == (s = this.value[a][0]) || "L" == s || "T" == s ? (this.value[a][1] += t,
                        this.value[a][2] += e) : "H" == s ? this.value[a][1] += t : "V" == s ? this.value[a][1] += e : "C" == s || "S" == s || "Q" == s ? (this.value[a][1] += t,
                        this.value[a][2] += e,
                        this.value[a][3] += t,
                        this.value[a][4] += e,
                        "C" == s && (this.value[a][5] += t,
                        this.value[a][6] += e)) : "A" == s && (this.value[a][6] += t,
                        this.value[a][7] += e);
                return this
            },
            size: function(t, e) {
                var i, s, a = this.bbox();
                for (i = this.value.length - 1; i >= 0; i--)
                    "M" == (s = this.value[i][0]) || "L" == s || "T" == s ? (this.value[i][1] = (this.value[i][1] - a.x) * t / a.width + a.x,
                    this.value[i][2] = (this.value[i][2] - a.y) * e / a.height + a.y) : "H" == s ? this.value[i][1] = (this.value[i][1] - a.x) * t / a.width + a.x : "V" == s ? this.value[i][1] = (this.value[i][1] - a.y) * e / a.height + a.y : "C" == s || "S" == s || "Q" == s ? (this.value[i][1] = (this.value[i][1] - a.x) * t / a.width + a.x,
                    ...
                    "C" == s && (this.value[i][5] = (this.value[i][5] - a.x) * t / a.width + a.x,
                    this.value[i][6] = (this.value[i][6] - a.y) * e / a.height + a.y)) : "A" == s && (this.value[i][1] = this.value[i][1] * t / a.width,
            ...
            equalCommands: function(t) {
                var e, i, a;
                for (t = new s.PathArray(t),
                a = this.value.length === t.value.length,
                e = 0,
                i = this.value.length; a && e < i; e++)
                    a = this.value[e][0] === t.value[e][0];
                return a
            },
            morph: function(t) {
                return t = new s.PathArray(t),
            ...
            parse: function(t) {
                ...
                var n = []
                  ...
                  , c = t.length;
                do {
                    s.regex.isPathLetter.test(t[l]) ? (e = t[l],
                    ++l) : "M" == e ? e = "L" : "m" == e && (e = "l"),
        ...
        s.Number = s.invent({
            create: function(t, e) {
                this.value = 0,
                this.unit = e || "",
                "number" == typeof t ? this.value = isNaN(t) ? 0 : isFinite(t) ? t : t < 0 ? -3.4e38 : 3.4e38 : "string" == typeof t ? (e = t.match(s.regex.numberAndUnit)) && (this.value = parseFloat(e[1]),
                "%" == e[5] ? this.value /= 100 : "s" == e[5] && (this.value *= 1e3),
                this.unit = e[5]) : t instanceof s.Number && (this.value = t.valueOf(),
                this.unit = t.unit)
            },
            extend: {
                toString: function() {
                ...
                plus: function(t) {
                    return t = new s.Number(t),
                    new s.Number(this + t,this.unit || t.unit)
                },
                minus: function(t) {
                    return t = new s.Number(t),
                    new s.Number(this - t,this.unit || t.unit)
                ...
                morph: function(t) {
                    return this.destination = new s.Number(t),
            ...
            extend: {
                ...
                parent: function(t) {
                    ...
                    if (!i.node.parentNode)
                        return null;
                    if (i = s.adopt(i.node.parentNode),
                    !t)
                        return i;
        ...
        s.FX = s.invent({
            ...
            extend: {
                ...
                target: function(t) {
                    return t && t instanceof s.Element ? (this._target = t,
                    this) : this._target
                },
                ...
                queue: function(t) {
                    return ("function" == typeof t || t instanceof s.Situation) && this.situations.push(t),
                ...
                initAnimations: function() {
                    ...
                    return a.initialTransformation = this.target().matrixify(),
                    a.init = !0,
                    this
                },
                clearQueue: function() {
                ...
                after: function(t) {
                    ...
                    return this.target().on("finished.fx", function i(s) {
                        s.detail.situation == e && (t.call(this, e),
                ...
                step: function(t) {
                    ...
                    s = this.situation.loop,
                    this.situation.loop = i) : (this.absPos = this.situation.loops,
                    this.pos = 1,
                    s = this.situation.loop - 1,
                    this.situation.loop = this.situation.loops),
                    this.situation.reversing && (this.situation.reversed = this.situation.reversed != Boolean((this.situation.loop - s) % 2))) : (this.absPos = Math.min(this.absPos, 1),
                    this.pos = this.absPos);
                    this.pos < 0 && (this.pos = 0),
                    this.situation.reversed && (this.pos = 1 - this.pos);
                    var a = this.situation.ease(this.pos);
                    for (var n in this.situation.once)
                        n > this.lastPos && n <= a && (this.situation.once[n].call(this.target(), this.pos, a),
                ...
                eachAt: function() {
                    ...
                    if (r.transforms.length) {
                        ...
                        e = r.transforms.length; t < e; t++) {
                            ...
                            o instanceof s.Matrix ? i = o.relative ? i.multiply((new s.Matrix).morph(o).at(r.ease(this.pos))) : i.morph(o).at(r.ease(this.pos)) : (o.relative || o.undo(i.extract()),
        ...
        s.MorphObj = s.invent({
            create: function(t, e) {
                return s.Color.isColor(e) ? new s.Color(t).morph(e) : s.regex.delimiter.test(t) ? s.regex.pathLetters.test(t) ? new s.PathArray(t).morph(e) : new s.Array(t).morph(e) : s.regex.numberAndUnit.test(e) ? new s.Number(t).morph(e) : (this.value = t,
        ...
        s.extend(s.FX, {
            ...
            size: function(t, e) {
                var i;
                this.target()instanceof s.Text ? this.attr("font-size", t) : (t && e || (i = this.target().bbox()),
            ...
            viewbox: function(t, e, i, a) {
                return this.target()instanceof s.Container && this.add("viewbox", new s.ViewBox(t,e,i,a)),
                this
            },
            update: function(t) {
        ...
        s.BBox = s.invent({
            create: function(t) {
                if (s.Box.apply(this, [].slice.call(arguments)),
                t instanceof s.Element) {
                    var e;
                    try {
        ...
        s.Matrix = s.invent({
            create: function(e) {
                ...
                for (e = e instanceof s.Element ? e.matrixify() : "string" == typeof e ? p(e.split(s.regex.delimiter).map(parseFloat)) : 6 == arguments.length ? p([].slice.call(arguments)) : Array.isArray(e) ? p(e) : "object" === t(e) ? e : a,
                i = y.length - 1; i >= 0; --i)
            ...
            extend: {
                ...
                morph: function(t) {
                    return this.destination = new s.Matrix(t),
                    this
                },
                at: function(t) {
                ...
                scale: function(t, e, i, a) {
                    return 1 == arguments.length ? e = t : 3 == arguments.length && (a = i,
                    i = e,
                    e = t),
                    this.around(i, a, new s.Matrix(t,0,0,e,0,0))
                },
                rotate: function(t, e, i) {
                    return t = s.utils.radians(t),
        ...
        s.Point = s.invent({
            ...
            extend: {
                ...
                morph: function(t, e) {
                    return this.destination = new s.Point(t,e),
                    this
                },
                at: function(t) {
        ...
        s.extend(s.Element, {
            attr: function(e, i, a) {
                if (null == e) {
                    for (e = {},
                    a = (i = this.node.attributes).length - 1; a >= 0; a--)
                ...
                if ("object" === t(e))
                    ...
                    if (null == i)
                        return null == (i = this.node.getAttribute(e)) ? s.defaults.attrs[e] : s.regex.isNumber.test(i) ? parseFloat(i) : i;
                    "stroke-width" == e ? this.attr("stroke", parseFloat(i) > 0 ? this._stroke : null) : "stroke" == e && (this._stroke = i),
                    "fill" != e && "stroke" != e || (s.regex.isImage.test(i) && (i = this.doc().defs().image(i, 0, 0)),
                    i instanceof s.Image && (i = this.doc().defs().pattern(0, 0, function() {
                        this.add(i)
                    }))),
        ...
        s.extend(s.Element, {
            transform: function(e, i) {
                var a, n;
                if ("object" !== t(e))
                    return a = new s.Matrix(this).extract(),
                    "string" == typeof e ? a[e] : a;
                if (a = new s.Matrix(this),
                i = !!i || !!e.relative,
                null != e.a)
                    ...
                    a = (new s.Matrix).flip(e.flip, e.offset)) : null == e.x && null == e.y || (i ? a = a.translate(e.x, e.y) : (null != e.x && (a.e = e.x),
                    null != e.y && (a.f = e.y)));
        ...
        s.extend(s.FX, {
            transform: function(e, i) {
                ...
                return "object" !== t(e) ? (a = new s.Matrix(r).extract(),
                "string" == typeof e ? a[e] : a) : (i = !!i || !!e.relative,
                null != e.a ? a = new s.Matrix(e) : null != e.rotation ? (x(e, r),
                a = new s.Rotate(e.rotation,e.cx,e.cy)) : null != e.scale || null != e.scaleX || null != e.scaleY ? (x(e, r),
                e.scaleX = null != e.scale ? e.scale : null != e.scaleX ? e.scaleX : 1,
                e.scaleY = null != e.scale ? e.scale : null != e.scaleY ? e.scaleY : 1,
                a = new s.Scale(e.scaleX,e.scaleY,e.cx,e.cy)) : null != e.skewX || null != e.skewY ? (x(e, r),
                e.skewX = null != e.skewX ? e.skewX : 0,
                e.skewY = null != e.skewY ? e.skewY : 0,
                a = new s.Skew(e.skewX,e.skewY,e.cx,e.cy)) : e.flip ? ("x" == e.flip || "y" == e.flip ? e.offset = null == e.offset ? r.bbox()["c" + e.flip] : e.offset : null == e.offset ? (n = r.bbox(),
                e.flip = n.cx,
                e.offset = n.cy) : e.flip = e.offset,
                a = (new s.Matrix).flip(e.flip, e.offset)) : null == e.x && null == e.y || (a = new s.Translate(e.x,e.y)),
                a ? (a.relative = i,
                this.last().transforms.push(a),
        ...
        s.Transformation = s.invent({
            create: function(e, i) {
                ...
                if (Array.isArray(e))
                    for (var s = 0, a = this.arguments.length; s < a; ++s)
                        this[this.arguments[s]] = e[s];
                else if ("object" === t(e))
                    for (s = 0,
                    a = this.arguments.length; s < a; ++s)
            ...
            extend: {
                ...
                at: function(t) {
                    ...
                    return n = (new s.Matrix).morph(s.Matrix.prototype[this.method].apply(n, e)).at(t),
                ...
                undo: function(t) {
                    ...
                    return t.cx = this.cx,
                    t.cy = this.cy,
                    this._undo = new (s[d(this.method)])(t,!0).at(1),
                    this
                }
            }
        }),
        ...
        s.extend(s.Element, {
            style: function(e, i) {
                ...
                if (arguments.length < 2)
                    ...
                    this.node.style[c(e)] = null === i || s.regex.isBlank.test(i) ? "" : i;
                return this
            }
        }),
        s.Parent = s.invent({
            ...
            extend: {
                ...
                each: function(t, e) {
                    ...
                    for (i = 0,
                    a = n.length; i < a; i++)
                        n[i]instanceof s.Element && t.apply(n[i], [i, n]),
                        e && n[i]instanceof s.Container && n[i].each(t, e);
                    return this
                },
        ...
        s.extend(s.Parent, {
            ungroup: function(t, e) {
                return 0 === e || this instanceof s.Defs || this.node == s.parser.draw ? this : (t = t || (this instanceof s.Doc ? this : this.parent(s.Parent)),
                e = e || 1 / 0,
                this.each(function() {
        ...
        s.ViewBox = s.invent({
            create: function(e) {
                ...
                if (e instanceof s.Element) {
                    ...
                    r = new s.Number(e.height()); "%" == n.unit; )
                        c *= n.value,
            ...
            extend: {
                ...
                morph: function(t, e, i, a) {
                    return this.destination = new s.ViewBox(t,e,i,a),
                    this
                },
                at: function(t) {
        ...
        s.off = function(t, e, i) {
            ...
            if (-1 != a)
                if (i) {
                    ...
                    !i)
                        return;
                    s.listeners[a][n] && s.listeners[a][n][r || "*"] && (t.removeEventListener(n, s.listeners[a][n][r || "*"][i], !1),
                    delete s.listeners[a][n][r || "*"][i])
                } else if (r && n) {
                    ...
                    delete s.handlerMap[a]
                }
        }
        ,
        s.extend(s.Element, {
            on: function(t, e, i, a) {
                return s.on(this.node, t, e, i, a),
                this
            },
            off: function(t, e) {
                return s.off(this.node, t, e),
                this
            },
            fire: function(t, i) {
        ...
        s.Doc = s.invent({
            create: function(t) {
                t && ("svg" == (t = "string" == typeof t ? i.getElementById(t) : t).nodeName ? this.constructor.call(this, t) : (this.constructor.call(this, s.create("svg")),
            ...
            extend: {
                ...
                defs: function() {
                    var t;
                    this._defs || ((t = this.node.getElementsByTagName("defs")[0]) ? this._defs = s.adopt(t) : this._defs = new s.Defs,
        ...
        s.extend(s.Element, {
            ...
            forward: function() {
                ...
                e instanceof s.Doc && e.node.appendChild(e.defs().node),
                this
            },
            backward: function() {
                var t = this.position();
            ...
            front: function() {
                ...
                t instanceof s.Doc && t.node.appendChild(t.defs().node),
                this
            },
            back: function() {
        ...
        s.Mask = s.invent({
            create: function() {
                this.constructor.call(this, s.create("mask")),
                this.targets = []
            },
            inherit: s.Container,
            extend: {
                remove: function() {
                    ...
                    return this.targets = [],
                    s.Element.prototype.remove.call(this),
                    this
                }
            },
            construct: {
        ...
        s.extend(s.Element, {
            maskWith: function(t) {
                return this.masker = t instanceof s.Mask ? t : this.parent().mask().add(t),
        ...
        s.ClipPath = s.invent({
            create: function() {
                this.constructor.call(this, s.create("clipPath")),
                this.targets = []
            },
            inherit: s.Container,
            extend: {
        ...
        s.extend(s.Element, {
            clipWith: function(t) {
                return this.clipper = t instanceof s.ClipPath ? t : this.parent().clip().add(t),
        ...
        s.Gradient = s.invent({
            create: function(t) {
                this.constructor.call(this, s.create(t + "Gradient")),
                this.type = t
            },
            inherit: s.Container,
            extend: {
                ...
                attr: function(t, e, i) {
                    ...
                    s.Container.prototype.attr.call(this, t, e, i)
                }
            },
            construct: {
        ...
        s.Bare = s.invent({
            create: function(t, e) {
                if (this.constructor.call(this, s.create(t)),
                e)
            ...
            extend: {
                load: function(t) {
                    ...
                    return s.on(a, "load", function() {
                        ...
                        null !== e && (0 == i.width() && 0 == i.height() && i.size(a.width, a.height),
        ...
        s.Text = s.invent({
            ...
            extend: {
                ...
                leading: function(t) {
                    return null == t ? this.dom.leading : (this.dom.leading = new s.Number(t),
                    this.rebuild())
                },
                lines: function() {
                ...
                rebuild: function(t) {
                    ...
                    this._rebuild) {
                        ...
                        this.lines().each(function() {
                            ...
                            "\n" == this.text() ? i += a : (this.attr("dy", a + i),
                            i = 0))
                        }),
                        this.fire("rebuild")
                    }
                ...
                setData: function(t) {
                    return this.dom = t,
                    this.dom.leading = new s.Number(t.leading || 1.3),
                    this
                }
            },
            construct: {
        ...
        ["fill", "stroke"].forEach(function(t) {
            ...
            i[t] = function(i) {
                if (void 0 === i)
                    return this;
                if ("string" == typeof i || s.Color.isRgb(i) || i && "function" == typeof i.fill)
                    this.attr(t, i);
                else
        ...
        s.extend(s.Element, {
            data: function(e, i, s) {
                if ("object" === t(e))
                    ...
                    this.attr("data-" + e, null === i ? null : !0 === s || "string" == typeof i || "number" == typeof i ? i : JSON.stringify(i));
                return this
            }
        }),
        s.extend(s.Element, {
    ...
    function() {
        function t(t, a, n, r, o, l, h) {
            for (var c = t.slice(a, n || h), d = r.slice(o, l || h), u = 0, g = {
                ...
                if (c[u] = e.call(g, c[u]),
                d[u] = e.call(f, d[u]),
                c[u][0] != d[u][0] || "M" == c[u][0] || "A" == c[u][0] && (c[u][4] != d[u][4] || c[u][5] != d[u][5]) ? (Array.prototype.splice.apply(c, [u, 1].concat(s.call(g, c[u]))),
                Array.prototype.splice.apply(d, [u, 1].concat(s.call(f, d[u])))) : (c[u] = i.call(g, c[u]),
                d[u] = i.call(f, d[u])),
        ...
        function s(t) {
            ...
            case "A":
                t = (e = function(t, e) {
                    var i, s, a, n, r, o, l, h, c, d, u, g, f, p, x, b, m, v, y, w, k, A, S, C, L, z, M = Math.abs(e[1]), P = Math.abs(e[2]), E = e[3] % 360, T = e[4], X = e[5], Y = e[6], I = e[7], F = new SVG.Point(t), O = new SVG.Point(Y,I), D = [];
                    if (0 === M || 0 === P || F.x === O.x && F.y === O.y)
                        return [["C", F.x, F.y, O.x, O.y, O.x, O.y]];
                    i = new SVG.Point((F.x - O.x) / 2,(F.y - O.y) / 2).transform((new SVG.Matrix).rotate(E)),
                    (s = i.x * i.x / (M * M) + i.y * i.y / (P * P)) > 1 && (s = Math.sqrt(s),
                    M *= s,
                    P *= s);
                    a = (new SVG.Matrix).rotate(E).scale(1 / M, 1 / P).rotate(-E),
                    F = F.transform(a),
                    O = O.transform(a),
                    n = [O.x - F.x, O.y - F.y],
                    o = n[0] * n[0] + n[1] * n[1],
                    ...
                    k = 0,
                    A = b.length; k < A; k++)
                        b[k][0] = b[k][0].transform(a),
                        b[k][1] = b[k][1].transform(a),
                        b[k][2] = b[k][2].transform(a);
                    for (k = 1,
                    A = b.length; k < A; k++)
                        w = b[k - 1][2],
                        S = w.x,
    ...
    function() {
        ...
        t.prototype.drag = function(t) {
            ...
            if ("function" == typeof n) {
                ...
                "object" == typeof n && (null != n.minX && s < n.minX ? s = n.minX : null != n.maxX && s > n.maxX - e.width && (s = n.maxX - e.width),
        ...
        SVG.extend(SVG.Element, {
            draggable: function(e, i) {
                ...
                return (e = void 0 === e || e) ? s.init(i || {}, e) : (this.off("mousedown.drag"),
    ...
    function() {
        ...
        t.prototype.selectRect = function(t) {
            ...
            this.options.points && !this.rectSelection.set.get(1)) {
                var a = "touchstart"
                  , n = "mousedown";
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(0, 0).attr("class", this.options.classPoints + "_lt").on(n, s("lt")).on(a, s("lt"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width, 0).attr("class", this.options.classPoints + "_rt").on(n, s("rt")).on(a, s("rt"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width, i.height).attr("class", this.options.classPoints + "_rb").on(n, s("rb")).on(a, s("rb"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(0, i.height).attr("class", this.options.classPoints + "_lb").on(n, s("lb")).on(a, s("lb"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width / 2, 0).attr("class", this.options.classPoints + "_t").on(n, s("t")).on(a, s("t"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width, i.height / 2).attr("class", this.options.classPoints + "_r").on(n, s("r")).on(a, s("r"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width / 2, i.height).attr("class", this.options.classPoints + "_b").on(n, s("b")).on(a, s("b"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(0, i.height / 2).attr("class", this.options.classPoints + "_l").on(n, s("l")).on(a, s("l"))),
    ...
    function() {
        (function() {
            ...
            t.prototype.snapToGrid = function(t, e, i, s) {
                var a;
                return void 0 !== s ? a = [(i + t) % this.options.snapToGrid, (s + e) % this.options.snapToGrid] : (i = null == i ? 3 : i,
            ...
            t.prototype.constraintToBox = function(t, e, i, s) {
                ...
                return void 0 !== s ? (a = i,
                n = s) : (a = this.parameters.box.x + (1 & i ? 0 : this.parameters.box.width),
            ...
            t.prototype.checkAspectRatio = function(t) {
                ...
                var e = t.slice()
                  ...
                  , n = s / a;
                return n < i ? e[1] = s / i - this.parameters.box.height : n > i && (e[0] = this.parameters.box.width - a * i),
                e
            }
            ,
            SVG.extend(SVG.Element, {
    ...
    function() {
        ...
        ), o = !1, l = "", h = "animationstart", c = "Webkit Moz O ms".split(" "), d = "webkitAnimationStart animationstart oAnimationStart MSAnimationStart".split(" "), u = document.createElement("fakeelement");
        if (void 0 !== u.style.animationName && (o = !0),
        !1 === o)
        ...
        window.addResizeListener = function(s, a) {
            s.__resizeTriggers__ || ("static" == getComputedStyle(s).position && (s.style.position = "relative"),
            function() {
                if (!t) {
            ...
            h && s.__resizeTriggers__.addEventListener(h, function(t) {
        ...
        window.removeResizeListener = function(t, e) {
            ...
            t.__resizeListeners__.length || (t.removeEventListener("scroll", i),
    ...
    function() {
        ...
        return s(i, [{
            ...
            value: function() {
                ...
                this.annotations = new b(this.ctx),
                ...
                this.titleSubtitle = new bt(this.ctx),
            ...
            value: function() {
                ...
                return new U(function(s, a) {
                    if (null === e.el)
                        return a(new Error("Not enough data to display or target element not found"));
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : []
                  ...
                  , i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
                return this.revertDefaultAxisMinMax(),
            ...
            value: function(t, e) {
                ...
                t[0].data ? (i = t.map(function(t, e) {
                    return n({}, a.config.series[e], {
                        name: t.name ? t.name : a.config.series[e].name,
                        data: t.data
                    })
                }),
                a.config.series = i) : a.config.series = t.slice(),
                s && (a.globals.initialConfig.series = JSON.parse(JSON.stringify(a.config.series)),
            ...
            value: function(t) {
                ...
                for (var s = i.w.config.series.slice(), a = 0; a < s.length; a++)
                    if (void 0 !== t[a])
                        for (var n = 0; n < t[a].data.length; n++)
            ...
            value: function() {
                ...
                t.config.yaxis.map(function(e, i) {
                    t.globals.zoomed && void 0 !== t.globals.lastYAxis[i] && (e.min = t.globals.lastYAxis[i].min,
                    e.max = t.globals.lastYAxis[i].max)
                })
            }
        }, {
            key: "clear",
            ...
            value: function() {
                ...
                ["mousedown", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"].forEach(function(s) {
                    i.addEventListener(s, function(i) {
                        "mousedown" === i.type && 1 === i.which || ("mouseup" === i.type && 1 === i.which || "touchend" === i.type) && ("function" == typeof t.config.chart.events.click && t.config.chart.events.click(i, e, t),
            ...
            value: function(t) {
                var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]
                  ...
                  , s = this;
                i && (s = i),
                s.annotations.addXaxisAnnotationExternal(t, e, s)
            }
        }, {
            key: "addYaxisAnnotation",
            value: function(t) {
                var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]
                  ...
                  , s = this;
                i && (s = i),
                s.annotations.addYaxisAnnotationExternal(t, e, s)
            }
        }, {
            key: "addPointAnnotation",
            value: function(t) {
                var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]
                  ...
                  , s = this;
                i && (s = i),
                s.annotations.addPointAnnotationExternal(t, e, s)
            }
        }, {
            key: "clearAnnotations",
            value: function() {
...
(function($) {
    ...
    if ($("#apexchart-01").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-01"),options);
        chart.render()
    }
    if ($("#apexchart-02").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-02"),options);
        chart.render()
    }
    if ($("#apexchart-03").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-03"),options);
        chart.render()
    }
    if ($("#apexchart-04").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-04"),options);
        chart.render()
    }
    if ($("#apexchart-05").length) {
        var options = {
            ...
            series: [{
                name: "Males",
                data: [.4, .65, .76, .88, 1.5, 2.1, 2.9, 3.8]
            }, {
                name: "Females",
                data: [-.8, -1.05, -1.06, -1.18, -1.4, -2.2, -2.85, -3.7]
            }],
            grid: {
                xaxis: {
                    showLines: false
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-05"),options);
        chart.render()
    }
    if ($("#apexchart-06").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-06"),options);
        chart.render()
    }
    if ($("#apexchart-07").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-07"),options);
        chart.render()
    }
    if ($("#apexchart-08").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-08"),options);
        chart.render()
    }
    if ($("#apexchart-09").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-09"),options);
        chart.render()
    }
    if ($("#apexchart-10").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-10"),options);
        chart.render()
    }
    if ($("#apexchart-11").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-11"),options);
        chart.render()
    }
    if ($("#apexchart-12").length) {
        ...
        var chart = new ApexCharts(document.querySelector("#apexchart-12"),options);
        chart.render()
    }
